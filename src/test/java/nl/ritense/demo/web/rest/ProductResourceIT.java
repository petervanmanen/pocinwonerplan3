...
import static nl.ritense.demo.domain.ProductAsserts.*;
...
class ProductResourceIT {
    ...
    private static final String DEFAULT_CODEMUSEUMJAARKAART = "AAAAAAAAAA";
    private static final String UPDATED_CODEMUSEUMJAARKAART = "BBBBBBBBBB";
    ...
    private static final String DEFAULT_ENTREEKAART = "AAAAAAAAAA";
    private static final String UPDATED_ENTREEKAART = "BBBBBBBBBB";
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product()
            .codemuseumjaarkaart(DEFAULT_CODEMUSEUMJAARKAART)
            .datumeindegeldigheid(DEFAULT_DATUMEINDEGELDIGHEID)
            .datumstart(DEFAULT_DATUMSTART)
            .entreekaart(DEFAULT_ENTREEKAART)
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product()
            .codemuseumjaarkaart(UPDATED_CODEMUSEUMJAARKAART)
            .datumeindegeldigheid(UPDATED_DATUMEINDEGELDIGHEID)
            .datumstart(UPDATED_DATUMSTART)
            .entreekaart(UPDATED_ENTREEKAART)
    ...
    void getAllProducts() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.[*].codemuseumjaarkaart").value(hasItem(DEFAULT_CODEMUSEUMJAARKAART)))
            ...
            .andExpect(jsonPath("$.[*].entreekaart").value(hasItem(DEFAULT_ENTREEKAART)))
    ...
    void getProduct() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.codemuseumjaarkaart").value(DEFAULT_CODEMUSEUMJAARKAART))
            ...
            .andExpect(jsonPath("$.entreekaart").value(DEFAULT_ENTREEKAART))
