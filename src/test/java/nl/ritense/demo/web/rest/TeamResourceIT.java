...
import static nl.ritense.demo.domain.TeamAsserts.*;
...
import nl.ritense.demo.domain.Team;
import nl.ritense.demo.repository.TeamRepository;
...
class TeamResourceIT {
    ...
    public static Team createEntity(EntityManager em) {
        Team team = new Team().naam(DEFAULT_NAAM).omschrijving(DEFAULT_OMSCHRIJVING);
        return team;
    }
    ...
    public static Team createUpdatedEntity(EntityManager em) {
        Team team = new Team().naam(UPDATED_NAAM).omschrijving(UPDATED_OMSCHRIJVING);
        return team;
    }
    ...
    void putExistingTeam() throws Exception {
        ...
        updatedTeam.naam(UPDATED_NAAM).omschrijving(UPDATED_OMSCHRIJVING);
    ...
    void partialUpdateTeamWithPatch() throws Exception {
        ...
        partialUpdatedTeam.omschrijving(UPDATED_OMSCHRIJVING);
    ...
    void fullUpdateTeamWithPatch() throws Exception {
        ...
        partialUpdatedTeam.naam(UPDATED_NAAM).omschrijving(UPDATED_OMSCHRIJVING);
