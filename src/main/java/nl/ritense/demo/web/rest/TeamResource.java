...
/**
 * REST controller for managing {@link nl.ritense.demo.domain.Team}.
 */
@RestController
...
public class TeamResource {
    ...
    public ResponseEntity<Team> createTeam(@Valid @RequestBody Team team) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/teams/" + team.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, team.getId().toString()))
            .body(team);
    }
    ...
    public ResponseEntity<Team> partialUpdateTeam(
        ...
        Optional<Team> result = teamRepository
            ...
            .map(existingTeam -> {
                ...
                if (team.getOmschrijving() != null) {
                    existingTeam.setOmschrijving(team.getOmschrijving());
                }
