...
/**
 * REST controller for managing {@link nl.ritense.demo.domain.Client}.
 */
@RestController
    ...
    public ResponseEntity<Client> partialUpdateClient(
        ...
        Optional<Client> result = clientRepository
            ...
            .map(existingClient -> {
                ...
                if (client.getGezagsdragergekend() != null) {
                    existingClient.setGezagsdragergekend(client.getGezagsdragergekend());
                }
                if (client.getJuridischestatus() != null) {
                    existingClient.setJuridischestatus(client.getJuridischestatus());
                }
                if (client.getWettelijkevertegenwoordiging() != null) {
                    existingClient.setWettelijkevertegenwoordiging(client.getWettelijkevertegenwoordiging());
                }
