...
/**
 * REST controller for managing {@link nl.ritense.demo.domain.Contact}.
 */
@RestController
...
public class ContactResource {
    ...
    public ResponseEntity<Contact> partialUpdateContact(
        ...
        Optional<Contact> result = contactRepository
            ...
            .map(existingContact -> {
                if (contact.getContactsoort() != null) {
                    existingContact.setContactsoort(contact.getContactsoort());
                }
                if (contact.getDatum() != null) {
                    existingContact.setDatum(contact.getDatum());
                }
                if (contact.getTekst() != null) {
                    existingContact.setTekst(contact.getTekst());
                }
