...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './zelfredzaamheidmatrix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ZELFREDZAAMHEIDMATRIX_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ZELFREDZAAMHEIDMATRIX actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ZELFREDZAAMHEIDMATRIX actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ZELFREDZAAMHEIDMATRIX actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ZELFREDZAAMHEIDMATRIX actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ZELFREDZAAMHEIDMATRIX actions', async () => {
      const arg = 42666;
