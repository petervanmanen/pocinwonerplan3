...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OPDRACHTNEMER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OPDRACHTNEMER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OPDRACHTNEMER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OPDRACHTNEMER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OPDRACHTNEMER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OPDRACHTNEMER actions', async () => {
      const arg = 42666;
