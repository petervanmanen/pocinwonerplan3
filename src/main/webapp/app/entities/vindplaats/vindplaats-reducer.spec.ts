...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VINDPLAATS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VINDPLAATS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VINDPLAATS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VINDPLAATS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VINDPLAATS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VINDPLAATS actions', async () => {
      const arg = 42666;
