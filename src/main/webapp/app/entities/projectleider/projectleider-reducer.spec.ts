...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJECTLEIDER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PROJECTLEIDER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PROJECTLEIDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PROJECTLEIDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PROJECTLEIDER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PROJECTLEIDER actions', async () => {
      const arg = 42666;
