...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './kolk.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KOLK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KOLK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KOLK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_KOLK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_KOLK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KOLK actions', async () => {
      const arg = 42666;
