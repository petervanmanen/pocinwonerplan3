...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './raadslid.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RAADSLID_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RAADSLID actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RAADSLID actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RAADSLID actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RAADSLID actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RAADSLID actions', async () => {
      const arg = 42666;
