...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VERLENGINGZAAK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VERLENGINGZAAK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VERLENGINGZAAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VERLENGINGZAAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VERLENGINGZAAK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VERLENGINGZAAK actions', async () => {
      const arg = 42666;
