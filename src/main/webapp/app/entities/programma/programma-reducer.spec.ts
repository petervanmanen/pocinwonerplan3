...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './programma.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROGRAMMA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PROGRAMMA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PROGRAMMA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PROGRAMMA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PROGRAMMA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PROGRAMMA actions', async () => {
      const arg = 42666;
