...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './doelstellingsoort.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOELSTELLINGSOORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DOELSTELLINGSOORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DOELSTELLINGSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DOELSTELLINGSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DOELSTELLINGSOORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DOELSTELLINGSOORT actions', async () => {
      const arg = 42666;
