...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './put.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PUT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PUT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PUT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PUT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PUT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PUT actions', async () => {
      const arg = 42666;
