...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WERKGELEGENHEID_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WERKGELEGENHEID actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WERKGELEGENHEID actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WERKGELEGENHEID actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WERKGELEGENHEID actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WERKGELEGENHEID actions', async () => {
      const arg = 42666;
