...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HOOFDREKENING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HOOFDREKENING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HOOFDREKENING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HOOFDREKENING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HOOFDREKENING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HOOFDREKENING actions', async () => {
      const arg = 42666;
