...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './inspectie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSPECTIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INSPECTIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INSPECTIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INSPECTIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INSPECTIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INSPECTIE actions', async () => {
      const arg = 42666;
