...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './activa.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACTIVA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ACTIVA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ACTIVA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ACTIVA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ACTIVA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ACTIVA actions', async () => {
      const arg = 42666;
