...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './gemaal.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GEMAAL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GEMAAL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GEMAAL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_GEMAAL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_GEMAAL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GEMAAL actions', async () => {
      const arg = 42666;
