...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './soortoverigbouwwerk.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOORTOVERIGBOUWWERK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SOORTOVERIGBOUWWERK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SOORTOVERIGBOUWWERK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SOORTOVERIGBOUWWERK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SOORTOVERIGBOUWWERK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SOORTOVERIGBOUWWERK actions', async () => {
      const arg = 42666;
