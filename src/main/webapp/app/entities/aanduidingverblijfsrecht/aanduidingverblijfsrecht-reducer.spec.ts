...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './aanduidingverblijfsrecht.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AANDUIDINGVERBLIJFSRECHT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AANDUIDINGVERBLIJFSRECHT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AANDUIDINGVERBLIJFSRECHT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AANDUIDINGVERBLIJFSRECHT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AANDUIDINGVERBLIJFSRECHT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AANDUIDINGVERBLIJFSRECHT actions', async () => {
      const arg = 42666;
