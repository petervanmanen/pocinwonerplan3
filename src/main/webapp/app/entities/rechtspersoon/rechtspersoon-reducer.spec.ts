...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RECHTSPERSOON_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RECHTSPERSOON actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RECHTSPERSOON actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RECHTSPERSOON actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RECHTSPERSOON actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RECHTSPERSOON actions', async () => {
      const arg = 42666;
