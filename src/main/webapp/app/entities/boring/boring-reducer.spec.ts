...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './boring.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BORING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BORING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BORING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BORING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BORING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BORING actions', async () => {
      const arg = 42666;
