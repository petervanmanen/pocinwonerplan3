...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './locatieonroerendezaak.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOCATIEONROERENDEZAAK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LOCATIEONROERENDEZAAK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LOCATIEONROERENDEZAAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LOCATIEONROERENDEZAAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LOCATIEONROERENDEZAAK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LOCATIEONROERENDEZAAK actions', async () => {
      const arg = 42666;
