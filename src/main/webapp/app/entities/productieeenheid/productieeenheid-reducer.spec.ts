...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTIEEENHEID_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUCTIEEENHEID actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUCTIEEENHEID actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRODUCTIEEENHEID actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTIEEENHEID actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRODUCTIEEENHEID actions', async () => {
      const arg = 42666;
