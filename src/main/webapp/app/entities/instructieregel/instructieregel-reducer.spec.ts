...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSTRUCTIEREGEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INSTRUCTIEREGEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INSTRUCTIEREGEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INSTRUCTIEREGEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INSTRUCTIEREGEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INSTRUCTIEREGEL actions', async () => {
      const arg = 42666;
