...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './inzet.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INZET_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INZET actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INZET actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INZET actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INZET actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INZET actions', async () => {
      const arg = 42666;
