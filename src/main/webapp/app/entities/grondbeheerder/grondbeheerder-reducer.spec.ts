...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GRONDBEHEERDER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GRONDBEHEERDER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GRONDBEHEERDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_GRONDBEHEERDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_GRONDBEHEERDER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GRONDBEHEERDER actions', async () => {
      const arg = 42666;
