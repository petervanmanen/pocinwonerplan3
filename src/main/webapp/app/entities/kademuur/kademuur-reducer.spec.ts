...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './kademuur.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KADEMUUR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KADEMUUR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KADEMUUR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_KADEMUUR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_KADEMUUR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KADEMUUR actions', async () => {
      const arg = 42666;
