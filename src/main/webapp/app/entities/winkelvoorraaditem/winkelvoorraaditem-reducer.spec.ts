...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './winkelvoorraaditem.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WINKELVOORRAADITEM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WINKELVOORRAADITEM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WINKELVOORRAADITEM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WINKELVOORRAADITEM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WINKELVOORRAADITEM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WINKELVOORRAADITEM actions', async () => {
      const arg = 42666;
