...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VERBLIJFSOBJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VERBLIJFSOBJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VERBLIJFSOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VERBLIJFSOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VERBLIJFSOBJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VERBLIJFSOBJECT actions', async () => {
      const arg = 42666;
