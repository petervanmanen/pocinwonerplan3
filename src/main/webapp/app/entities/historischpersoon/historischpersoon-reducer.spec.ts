...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './historischpersoon.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HISTORISCHPERSOON_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HISTORISCHPERSOON actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HISTORISCHPERSOON actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HISTORISCHPERSOON actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HISTORISCHPERSOON actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HISTORISCHPERSOON actions', async () => {
      const arg = 42666;
