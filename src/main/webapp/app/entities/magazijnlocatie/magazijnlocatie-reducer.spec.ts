...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MAGAZIJNLOCATIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MAGAZIJNLOCATIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MAGAZIJNLOCATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MAGAZIJNLOCATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MAGAZIJNLOCATIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MAGAZIJNLOCATIE actions', async () => {
      const arg = 42666;
