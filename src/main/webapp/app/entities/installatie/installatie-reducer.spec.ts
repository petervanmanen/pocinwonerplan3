...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSTALLATIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INSTALLATIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INSTALLATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INSTALLATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INSTALLATIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INSTALLATIE actions', async () => {
      const arg = 42666;
