...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './vloginfo.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VLOGINFO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VLOGINFO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VLOGINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VLOGINFO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VLOGINFO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VLOGINFO actions', async () => {
      const arg = 42666;
