...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './fractie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FRACTIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FRACTIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FRACTIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FRACTIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FRACTIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FRACTIE actions', async () => {
      const arg = 42666;
