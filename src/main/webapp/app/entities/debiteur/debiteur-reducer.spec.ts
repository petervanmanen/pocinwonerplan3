...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './debiteur.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEBITEUR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DEBITEUR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DEBITEUR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DEBITEUR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DEBITEUR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DEBITEUR actions', async () => {
      const arg = 42666;
