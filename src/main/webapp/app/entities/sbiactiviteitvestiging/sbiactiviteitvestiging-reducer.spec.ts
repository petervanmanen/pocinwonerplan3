...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './sbiactiviteitvestiging.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SBIACTIVITEITVESTIGING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SBIACTIVITEITVESTIGING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SBIACTIVITEITVESTIGING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SBIACTIVITEITVESTIGING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SBIACTIVITEITVESTIGING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SBIACTIVITEITVESTIGING actions', async () => {
      const arg = 42666;
