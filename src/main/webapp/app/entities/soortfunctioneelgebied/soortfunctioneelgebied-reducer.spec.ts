...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './soortfunctioneelgebied.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOORTFUNCTIONEELGEBIED_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SOORTFUNCTIONEELGEBIED actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SOORTFUNCTIONEELGEBIED actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SOORTFUNCTIONEELGEBIED actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SOORTFUNCTIONEELGEBIED actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SOORTFUNCTIONEELGEBIED actions', async () => {
      const arg = 42666;
