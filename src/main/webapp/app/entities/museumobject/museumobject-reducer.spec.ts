...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MUSEUMOBJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MUSEUMOBJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MUSEUMOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MUSEUMOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MUSEUMOBJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MUSEUMOBJECT actions', async () => {
      const arg = 42666;
