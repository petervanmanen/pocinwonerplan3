...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './eigenaar.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EIGENAAR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EIGENAAR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EIGENAAR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_EIGENAAR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_EIGENAAR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EIGENAAR actions', async () => {
      const arg = 42666;
