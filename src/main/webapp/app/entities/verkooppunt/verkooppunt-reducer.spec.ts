...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VERKOOPPUNT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VERKOOPPUNT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VERKOOPPUNT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VERKOOPPUNT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VERKOOPPUNT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VERKOOPPUNT actions', async () => {
      const arg = 42666;
