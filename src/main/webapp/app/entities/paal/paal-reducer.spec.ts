...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './paal.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAAL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PAAL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PAAL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PAAL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PAAL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PAAL actions', async () => {
      const arg = 42666;
