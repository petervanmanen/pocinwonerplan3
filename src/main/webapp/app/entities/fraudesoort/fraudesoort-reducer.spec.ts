...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FRAUDESOORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FRAUDESOORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FRAUDESOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FRAUDESOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FRAUDESOORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FRAUDESOORT actions', async () => {
      const arg = 42666;
