...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VEGETATIEOBJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VEGETATIEOBJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VEGETATIEOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VEGETATIEOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VEGETATIEOBJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VEGETATIEOBJECT actions', async () => {
      const arg = 42666;
