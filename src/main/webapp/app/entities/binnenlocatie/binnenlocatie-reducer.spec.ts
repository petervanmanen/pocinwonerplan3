...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BINNENLOCATIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BINNENLOCATIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BINNENLOCATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BINNENLOCATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BINNENLOCATIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BINNENLOCATIE actions', async () => {
      const arg = 42666;
