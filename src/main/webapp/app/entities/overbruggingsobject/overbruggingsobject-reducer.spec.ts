...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './overbruggingsobject.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OVERBRUGGINGSOBJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OVERBRUGGINGSOBJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OVERBRUGGINGSOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OVERBRUGGINGSOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OVERBRUGGINGSOBJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OVERBRUGGINGSOBJECT actions', async () => {
      const arg = 42666;
