...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './aantal.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AANTAL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AANTAL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AANTAL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AANTAL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AANTAL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AANTAL actions', async () => {
      const arg = 42666;
