...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ONDERHOUDSKOSTEN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ONDERHOUDSKOSTEN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ONDERHOUDSKOSTEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ONDERHOUDSKOSTEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ONDERHOUDSKOSTEN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ONDERHOUDSKOSTEN actions', async () => {
      const arg = 42666;
