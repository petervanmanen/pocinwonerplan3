...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AANVRAAGSTADSPAS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AANVRAAGSTADSPAS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AANVRAAGSTADSPAS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AANVRAAGSTADSPAS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AANVRAAGSTADSPAS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AANVRAAGSTADSPAS actions', async () => {
      const arg = 42666;
