...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPECIFICATIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SPECIFICATIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SPECIFICATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SPECIFICATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SPECIFICATIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SPECIFICATIE actions', async () => {
      const arg = 42666;
