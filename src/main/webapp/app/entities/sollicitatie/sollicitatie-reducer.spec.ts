...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOLLICITATIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SOLLICITATIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SOLLICITATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SOLLICITATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SOLLICITATIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SOLLICITATIE actions', async () => {
      const arg = 42666;
