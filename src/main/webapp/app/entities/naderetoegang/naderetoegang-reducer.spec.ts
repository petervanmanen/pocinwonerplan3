...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NADERETOEGANG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NADERETOEGANG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NADERETOEGANG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_NADERETOEGANG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_NADERETOEGANG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NADERETOEGANG actions', async () => {
      const arg = 42666;
