...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './subsidiecomponent.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBSIDIECOMPONENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SUBSIDIECOMPONENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SUBSIDIECOMPONENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SUBSIDIECOMPONENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SUBSIDIECOMPONENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SUBSIDIECOMPONENT actions', async () => {
      const arg = 42666;
