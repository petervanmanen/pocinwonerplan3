...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRAJECTSOORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRAJECTSOORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRAJECTSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TRAJECTSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TRAJECTSOORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TRAJECTSOORT actions', async () => {
      const arg = 42666;
