...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COLLEGELID_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COLLEGELID actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COLLEGELID actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_COLLEGELID actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_COLLEGELID actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COLLEGELID actions', async () => {
      const arg = 42666;
