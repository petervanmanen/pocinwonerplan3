...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './nertwerkcomponent.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NERTWERKCOMPONENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NERTWERKCOMPONENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NERTWERKCOMPONENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_NERTWERKCOMPONENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_NERTWERKCOMPONENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NERTWERKCOMPONENT actions', async () => {
      const arg = 42666;
