...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './tarief.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TARIEF_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TARIEF actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TARIEF actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TARIEF actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TARIEF actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TARIEF actions', async () => {
      const arg = 42666;
