...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bak.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BAK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BAK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BAK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BAK actions', async () => {
      const arg = 42666;
