...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './functie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FUNCTIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FUNCTIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FUNCTIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FUNCTIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FUNCTIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FUNCTIE actions', async () => {
      const arg = 42666;
