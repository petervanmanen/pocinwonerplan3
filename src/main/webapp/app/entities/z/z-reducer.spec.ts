...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './z.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_Z_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_Z actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_Z actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_Z actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_Z actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_Z actions', async () => {
      const arg = 42666;
