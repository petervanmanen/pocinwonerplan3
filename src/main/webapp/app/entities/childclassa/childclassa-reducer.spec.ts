...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHILDCLASSA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CHILDCLASSA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CHILDCLASSA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CHILDCLASSA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CHILDCLASSA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CHILDCLASSA actions', async () => {
      const arg = 42666;
