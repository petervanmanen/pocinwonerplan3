...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './relatie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RELATIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RELATIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RELATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RELATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RELATIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RELATIE actions', async () => {
      const arg = 42666;
