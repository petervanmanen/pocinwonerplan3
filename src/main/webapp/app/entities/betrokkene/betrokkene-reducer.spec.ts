...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BETROKKENE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BETROKKENE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BETROKKENE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BETROKKENE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BETROKKENE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BETROKKENE actions', async () => {
      const arg = 42666;
