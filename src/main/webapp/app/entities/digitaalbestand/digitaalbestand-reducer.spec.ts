...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DIGITAALBESTAND_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DIGITAALBESTAND actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DIGITAALBESTAND actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DIGITAALBESTAND actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DIGITAALBESTAND actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DIGITAALBESTAND actions', async () => {
      const arg = 42666;
