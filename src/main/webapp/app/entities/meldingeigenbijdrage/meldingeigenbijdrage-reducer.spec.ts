...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './meldingeigenbijdrage.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MELDINGEIGENBIJDRAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MELDINGEIGENBIJDRAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MELDINGEIGENBIJDRAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MELDINGEIGENBIJDRAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MELDINGEIGENBIJDRAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MELDINGEIGENBIJDRAGE actions', async () => {
      const arg = 42666;
