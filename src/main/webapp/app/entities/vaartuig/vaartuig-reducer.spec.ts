...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './vaartuig.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VAARTUIG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VAARTUIG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VAARTUIG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VAARTUIG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VAARTUIG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VAARTUIG actions', async () => {
      const arg = 42666;
