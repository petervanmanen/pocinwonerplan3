...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOLITAIREPLANT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SOLITAIREPLANT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SOLITAIREPLANT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SOLITAIREPLANT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SOLITAIREPLANT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SOLITAIREPLANT actions', async () => {
      const arg = 42666;
