...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBSIDIEAANVRAAG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SUBSIDIEAANVRAAG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SUBSIDIEAANVRAAG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SUBSIDIEAANVRAAG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SUBSIDIEAANVRAAG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SUBSIDIEAANVRAAG actions', async () => {
      const arg = 42666;
