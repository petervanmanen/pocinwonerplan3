...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './punt.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PUNT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PUNT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PUNT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PUNT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PUNT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PUNT actions', async () => {
      const arg = 42666;
