...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTSOORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUCTSOORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUCTSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRODUCTSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTSOORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRODUCTSOORT actions', async () => {
      const arg = 42666;
