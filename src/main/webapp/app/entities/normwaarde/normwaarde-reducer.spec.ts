...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NORMWAARDE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NORMWAARDE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NORMWAARDE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_NORMWAARDE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_NORMWAARDE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NORMWAARDE actions', async () => {
      const arg = 42666;
