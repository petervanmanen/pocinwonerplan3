...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WOZDEELOBJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WOZDEELOBJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WOZDEELOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WOZDEELOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WOZDEELOBJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WOZDEELOBJECT actions', async () => {
      const arg = 42666;
