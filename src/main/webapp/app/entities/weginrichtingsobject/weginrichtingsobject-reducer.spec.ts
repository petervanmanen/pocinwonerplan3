...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './weginrichtingsobject.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WEGINRICHTINGSOBJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WEGINRICHTINGSOBJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WEGINRICHTINGSOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WEGINRICHTINGSOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WEGINRICHTINGSOBJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WEGINRICHTINGSOBJECT actions', async () => {
      const arg = 42666;
