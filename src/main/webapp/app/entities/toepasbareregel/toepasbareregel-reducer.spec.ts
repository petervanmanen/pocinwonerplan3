...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOEPASBAREREGEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TOEPASBAREREGEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TOEPASBAREREGEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TOEPASBAREREGEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TOEPASBAREREGEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TOEPASBAREREGEL actions', async () => {
      const arg = 42666;
