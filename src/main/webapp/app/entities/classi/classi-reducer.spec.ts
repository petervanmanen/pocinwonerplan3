...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './classi.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLASSI_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CLASSI actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CLASSI actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CLASSI actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CLASSI actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CLASSI actions', async () => {
      const arg = 42666;
