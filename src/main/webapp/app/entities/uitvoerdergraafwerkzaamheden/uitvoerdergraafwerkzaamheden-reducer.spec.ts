...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './uitvoerdergraafwerkzaamheden.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UITVOERDERGRAAFWERKZAAMHEDEN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_UITVOERDERGRAAFWERKZAAMHEDEN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_UITVOERDERGRAAFWERKZAAMHEDEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_UITVOERDERGRAAFWERKZAAMHEDEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_UITVOERDERGRAAFWERKZAAMHEDEN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_UITVOERDERGRAAFWERKZAAMHEDEN actions', async () => {
      const arg = 42666;
