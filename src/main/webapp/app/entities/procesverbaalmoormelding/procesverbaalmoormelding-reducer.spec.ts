...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './procesverbaalmoormelding.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROCESVERBAALMOORMELDING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PROCESVERBAALMOORMELDING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PROCESVERBAALMOORMELDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PROCESVERBAALMOORMELDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PROCESVERBAALMOORMELDING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PROCESVERBAALMOORMELDING actions', async () => {
      const arg = 42666;
