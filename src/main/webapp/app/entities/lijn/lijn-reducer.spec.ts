...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './lijn.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LIJN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LIJN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LIJN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LIJN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LIJN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LIJN actions', async () => {
      const arg = 42666;
