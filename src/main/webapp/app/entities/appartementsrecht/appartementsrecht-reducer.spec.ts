...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './appartementsrecht.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPARTEMENTSRECHT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_APPARTEMENTSRECHT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_APPARTEMENTSRECHT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_APPARTEMENTSRECHT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_APPARTEMENTSRECHT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_APPARTEMENTSRECHT actions', async () => {
      const arg = 42666;
