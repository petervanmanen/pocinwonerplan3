...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DECLARATIESOORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DECLARATIESOORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DECLARATIESOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DECLARATIESOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DECLARATIESOORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DECLARATIESOORT actions', async () => {
      const arg = 42666;
