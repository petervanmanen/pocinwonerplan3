...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FORMELEHISTORIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FORMELEHISTORIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FORMELEHISTORIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FORMELEHISTORIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FORMELEHISTORIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FORMELEHISTORIE actions', async () => {
      const arg = 42666;
