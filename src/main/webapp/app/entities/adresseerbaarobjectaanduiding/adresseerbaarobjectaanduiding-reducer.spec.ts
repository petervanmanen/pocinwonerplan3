...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './adresseerbaarobjectaanduiding.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADRESSEERBAAROBJECTAANDUIDING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ADRESSEERBAAROBJECTAANDUIDING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ADRESSEERBAAROBJECTAANDUIDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ADRESSEERBAAROBJECTAANDUIDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ADRESSEERBAAROBJECTAANDUIDING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ADRESSEERBAAROBJECTAANDUIDING actions', async () => {
      const arg = 42666;
