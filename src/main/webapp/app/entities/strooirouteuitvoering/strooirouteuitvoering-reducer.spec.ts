...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './strooirouteuitvoering.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STROOIROUTEUITVOERING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STROOIROUTEUITVOERING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STROOIROUTEUITVOERING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STROOIROUTEUITVOERING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STROOIROUTEUITVOERING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STROOIROUTEUITVOERING actions', async () => {
      const arg = 42666;
