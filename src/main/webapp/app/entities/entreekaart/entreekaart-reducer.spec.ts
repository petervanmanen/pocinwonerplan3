...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENTREEKAART_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ENTREEKAART actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ENTREEKAART actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ENTREEKAART actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ENTREEKAART actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ENTREEKAART actions', async () => {
      const arg = 42666;
