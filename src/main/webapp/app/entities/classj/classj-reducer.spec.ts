...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './classj.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLASSJ_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CLASSJ actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CLASSJ actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CLASSJ actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CLASSJ actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CLASSJ actions', async () => {
      const arg = 42666;
