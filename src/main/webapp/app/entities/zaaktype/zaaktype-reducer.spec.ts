...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './zaaktype.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ZAAKTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ZAAKTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ZAAKTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ZAAKTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ZAAKTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ZAAKTYPE actions', async () => {
      const arg = 42666;
