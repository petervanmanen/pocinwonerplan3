...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './cmdbitem.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CMDBITEM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CMDBITEM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CMDBITEM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CMDBITEM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CMDBITEM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CMDBITEM actions', async () => {
      const arg = 42666;
