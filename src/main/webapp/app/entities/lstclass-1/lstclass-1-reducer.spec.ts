...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LSTCLASS1_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LSTCLASS1 actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LSTCLASS1 actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LSTCLASS1 actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LSTCLASS1 actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LSTCLASS1 actions', async () => {
      const arg = 42666;
