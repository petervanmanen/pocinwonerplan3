...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPLICATIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_APPLICATIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_APPLICATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_APPLICATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_APPLICATIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_APPLICATIE actions', async () => {
      const arg = 42666;
