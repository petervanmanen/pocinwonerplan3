...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARTEFACTSOORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ARTEFACTSOORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ARTEFACTSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ARTEFACTSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ARTEFACTSOORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ARTEFACTSOORT actions', async () => {
      const arg = 42666;
