...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BEMALINGSGEBIED_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BEMALINGSGEBIED actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BEMALINGSGEBIED actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BEMALINGSGEBIED actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BEMALINGSGEBIED actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BEMALINGSGEBIED actions', async () => {
      const arg = 42666;
