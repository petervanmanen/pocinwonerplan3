...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './adresseerbaarobject.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADRESSEERBAAROBJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ADRESSEERBAAROBJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ADRESSEERBAAROBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ADRESSEERBAAROBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ADRESSEERBAAROBJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ADRESSEERBAAROBJECT actions', async () => {
      const arg = 42666;
