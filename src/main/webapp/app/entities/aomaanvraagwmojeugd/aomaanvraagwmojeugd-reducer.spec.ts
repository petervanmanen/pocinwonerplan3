...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './aomaanvraagwmojeugd.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AOMAANVRAAGWMOJEUGD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AOMAANVRAAGWMOJEUGD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AOMAANVRAAGWMOJEUGD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AOMAANVRAAGWMOJEUGD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AOMAANVRAAGWMOJEUGD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AOMAANVRAAGWMOJEUGD actions', async () => {
      const arg = 42666;
