...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TENAAMSTELLING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TENAAMSTELLING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TENAAMSTELLING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TENAAMSTELLING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TENAAMSTELLING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TENAAMSTELLING actions', async () => {
      const arg = 42666;
