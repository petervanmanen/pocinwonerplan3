...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './gunning.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GUNNING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GUNNING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GUNNING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_GUNNING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_GUNNING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GUNNING actions', async () => {
      const arg = 42666;
