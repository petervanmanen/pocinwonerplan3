...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANKREKENING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BANKREKENING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BANKREKENING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BANKREKENING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BANKREKENING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BANKREKENING actions', async () => {
      const arg = 42666;
