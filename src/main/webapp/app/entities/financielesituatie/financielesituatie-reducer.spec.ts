...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './financielesituatie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FINANCIELESITUATIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FINANCIELESITUATIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FINANCIELESITUATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FINANCIELESITUATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FINANCIELESITUATIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FINANCIELESITUATIE actions', async () => {
      const arg = 42666;
