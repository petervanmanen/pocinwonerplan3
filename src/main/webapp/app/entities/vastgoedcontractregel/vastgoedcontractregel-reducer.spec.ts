...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './vastgoedcontractregel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VASTGOEDCONTRACTREGEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VASTGOEDCONTRACTREGEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VASTGOEDCONTRACTREGEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VASTGOEDCONTRACTREGEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VASTGOEDCONTRACTREGEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VASTGOEDCONTRACTREGEL actions', async () => {
      const arg = 42666;
