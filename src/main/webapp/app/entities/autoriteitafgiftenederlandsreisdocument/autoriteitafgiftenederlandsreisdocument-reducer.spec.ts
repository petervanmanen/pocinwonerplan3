...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './autoriteitafgiftenederlandsreisdocument.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AUTORITEITAFGIFTENEDERLANDSREISDOCUMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AUTORITEITAFGIFTENEDERLANDSREISDOCUMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AUTORITEITAFGIFTENEDERLANDSREISDOCUMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AUTORITEITAFGIFTENEDERLANDSREISDOCUMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AUTORITEITAFGIFTENEDERLANDSREISDOCUMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AUTORITEITAFGIFTENEDERLANDSREISDOCUMENT actions', async () => {
      const arg = 42666;
