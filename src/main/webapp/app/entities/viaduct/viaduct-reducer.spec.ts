...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './viaduct.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VIADUCT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VIADUCT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VIADUCT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VIADUCT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VIADUCT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VIADUCT actions', async () => {
      const arg = 42666;
