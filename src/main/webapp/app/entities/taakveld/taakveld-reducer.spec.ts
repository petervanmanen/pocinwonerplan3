...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './taakveld.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TAAKVELD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TAAKVELD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TAAKVELD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TAAKVELD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TAAKVELD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TAAKVELD actions', async () => {
      const arg = 42666;
