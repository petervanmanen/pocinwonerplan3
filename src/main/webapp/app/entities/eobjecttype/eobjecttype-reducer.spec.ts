...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EOBJECTTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EOBJECTTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EOBJECTTYPE actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_EOBJECTTYPE actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_EOBJECTTYPE actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_EOBJECTTYPE actions', async () => {
      const arg = 42666;
