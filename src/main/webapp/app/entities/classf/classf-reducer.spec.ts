...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './classf.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLASSF_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CLASSF actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CLASSF actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CLASSF actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CLASSF actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CLASSF actions', async () => {
      const arg = 42666;
