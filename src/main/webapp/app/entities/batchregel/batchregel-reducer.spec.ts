...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BATCHREGEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BATCHREGEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BATCHREGEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BATCHREGEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BATCHREGEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BATCHREGEL actions', async () => {
      const arg = 42666;
