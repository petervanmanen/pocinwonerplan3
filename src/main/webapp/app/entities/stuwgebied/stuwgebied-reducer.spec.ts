...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STUWGEBIED_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STUWGEBIED actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STUWGEBIED actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STUWGEBIED actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STUWGEBIED actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STUWGEBIED actions', async () => {
      const arg = 42666;
