...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FRAUDEGEGEVENS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FRAUDEGEGEVENS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FRAUDEGEGEVENS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FRAUDEGEGEVENS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FRAUDEGEGEVENS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FRAUDEGEGEVENS actions', async () => {
      const arg = 42666;
