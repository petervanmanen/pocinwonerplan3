...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './vordering.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VORDERING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VORDERING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VORDERING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VORDERING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VORDERING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VORDERING actions', async () => {
      const arg = 42666;
