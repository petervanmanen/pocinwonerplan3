...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KPBETROKKENBIJ_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KPBETROKKENBIJ actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KPBETROKKENBIJ actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_KPBETROKKENBIJ actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_KPBETROKKENBIJ actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KPBETROKKENBIJ actions', async () => {
      const arg = 42666;
