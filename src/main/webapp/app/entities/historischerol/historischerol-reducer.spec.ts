...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HISTORISCHEROL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HISTORISCHEROL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HISTORISCHEROL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HISTORISCHEROL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HISTORISCHEROL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HISTORISCHEROL actions', async () => {
      const arg = 42666;
