...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './offerte.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OFFERTE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OFFERTE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OFFERTE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OFFERTE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OFFERTE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OFFERTE actions', async () => {
      const arg = 42666;
