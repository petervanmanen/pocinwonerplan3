...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './foto.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FOTO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FOTO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FOTO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FOTO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FOTO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FOTO actions', async () => {
      const arg = 42666;
