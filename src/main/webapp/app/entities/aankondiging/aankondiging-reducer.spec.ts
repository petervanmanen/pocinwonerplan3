...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AANKONDIGING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AANKONDIGING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AANKONDIGING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AANKONDIGING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AANKONDIGING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AANKONDIGING actions', async () => {
      const arg = 42666;
