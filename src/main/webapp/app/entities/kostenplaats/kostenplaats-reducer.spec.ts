...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KOSTENPLAATS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KOSTENPLAATS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KOSTENPLAATS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_KOSTENPLAATS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_KOSTENPLAATS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KOSTENPLAATS actions', async () => {
      const arg = 42666;
