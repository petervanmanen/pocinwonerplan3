...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OPSCHORTINGZAAK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OPSCHORTINGZAAK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OPSCHORTINGZAAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OPSCHORTINGZAAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OPSCHORTINGZAAK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OPSCHORTINGZAAK actions', async () => {
      const arg = 42666;
