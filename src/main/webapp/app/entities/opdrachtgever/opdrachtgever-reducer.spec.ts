...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OPDRACHTGEVER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OPDRACHTGEVER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OPDRACHTGEVER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OPDRACHTGEVER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OPDRACHTGEVER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OPDRACHTGEVER actions', async () => {
      const arg = 42666;
