...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OPENBARERUIMTE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OPENBARERUIMTE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OPENBARERUIMTE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OPENBARERUIMTE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OPENBARERUIMTE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OPENBARERUIMTE actions', async () => {
      const arg = 42666;
