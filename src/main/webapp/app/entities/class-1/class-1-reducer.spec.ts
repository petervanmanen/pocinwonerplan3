...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './class-1.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLASS1_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CLASS1 actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CLASS1 actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CLASS1 actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CLASS1 actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CLASS1 actions', async () => {
      const arg = 42666;
