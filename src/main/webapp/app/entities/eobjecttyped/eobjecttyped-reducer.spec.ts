...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EOBJECTTYPED_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EOBJECTTYPED actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EOBJECTTYPED actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_EOBJECTTYPED actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_EOBJECTTYPED actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EOBJECTTYPED actions', async () => {
      const arg = 42666;
