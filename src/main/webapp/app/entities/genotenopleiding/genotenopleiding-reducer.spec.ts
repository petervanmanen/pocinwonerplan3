...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GENOTENOPLEIDING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GENOTENOPLEIDING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GENOTENOPLEIDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_GENOTENOPLEIDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_GENOTENOPLEIDING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GENOTENOPLEIDING actions', async () => {
      const arg = 42666;
