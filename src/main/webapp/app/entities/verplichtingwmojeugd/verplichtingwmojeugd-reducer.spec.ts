...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './verplichtingwmojeugd.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VERPLICHTINGWMOJEUGD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VERPLICHTINGWMOJEUGD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VERPLICHTINGWMOJEUGD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VERPLICHTINGWMOJEUGD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VERPLICHTINGWMOJEUGD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VERPLICHTINGWMOJEUGD actions', async () => {
      const arg = 42666;
