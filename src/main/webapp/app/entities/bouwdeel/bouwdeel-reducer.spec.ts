...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bouwdeel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOUWDEEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BOUWDEEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BOUWDEEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BOUWDEEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BOUWDEEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BOUWDEEL actions', async () => {
      const arg = 42666;
