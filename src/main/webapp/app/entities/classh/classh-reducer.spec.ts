...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './classh.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLASSH_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CLASSH actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CLASSH actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CLASSH actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CLASSH actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CLASSH actions', async () => {
      const arg = 42666;
