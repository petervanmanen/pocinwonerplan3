...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './ligplaatsontheffing.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LIGPLAATSONTHEFFING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LIGPLAATSONTHEFFING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LIGPLAATSONTHEFFING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LIGPLAATSONTHEFFING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LIGPLAATSONTHEFFING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LIGPLAATSONTHEFFING actions', async () => {
      const arg = 42666;
