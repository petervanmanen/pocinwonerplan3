...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OUDEROFVERZORGER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OUDEROFVERZORGER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OUDEROFVERZORGER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OUDEROFVERZORGER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OUDEROFVERZORGER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OUDEROFVERZORGER actions', async () => {
      const arg = 42666;
