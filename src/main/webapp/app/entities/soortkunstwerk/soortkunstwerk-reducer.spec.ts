...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOORTKUNSTWERK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SOORTKUNSTWERK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SOORTKUNSTWERK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SOORTKUNSTWERK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SOORTKUNSTWERK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SOORTKUNSTWERK actions', async () => {
      const arg = 42666;
