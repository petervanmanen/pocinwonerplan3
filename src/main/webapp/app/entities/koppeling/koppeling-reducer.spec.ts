...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './koppeling.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KOPPELING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KOPPELING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KOPPELING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_KOPPELING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_KOPPELING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KOPPELING actions', async () => {
      const arg = 42666;
