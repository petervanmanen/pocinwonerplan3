...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BELANGTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BELANGTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BELANGTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BELANGTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BELANGTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BELANGTYPE actions', async () => {
      const arg = 42666;
