...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WOONPLAATS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WOONPLAATS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WOONPLAATS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WOONPLAATS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WOONPLAATS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WOONPLAATS actions', async () => {
      const arg = 42666;
