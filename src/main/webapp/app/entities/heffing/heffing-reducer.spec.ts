...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './heffing.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HEFFING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HEFFING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HEFFING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HEFFING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HEFFING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HEFFING actions', async () => {
      const arg = 42666;
