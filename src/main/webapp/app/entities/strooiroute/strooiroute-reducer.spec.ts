...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STROOIROUTE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STROOIROUTE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STROOIROUTE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STROOIROUTE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STROOIROUTE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STROOIROUTE actions', async () => {
      const arg = 42666;
