...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EOBJECTRELATIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EOBJECTRELATIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EOBJECTRELATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_EOBJECTRELATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_EOBJECTRELATIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EOBJECTRELATIE actions', async () => {
      const arg = 42666;
