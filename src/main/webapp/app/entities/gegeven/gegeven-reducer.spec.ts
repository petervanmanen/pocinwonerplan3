...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './gegeven.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GEGEVEN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GEGEVEN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GEGEVEN actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_GEGEVEN actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_GEGEVEN actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_GEGEVEN actions', async () => {
      const arg = 42666;
