...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './bankafschriftregel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANKAFSCHRIFTREGEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BANKAFSCHRIFTREGEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BANKAFSCHRIFTREGEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BANKAFSCHRIFTREGEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BANKAFSCHRIFTREGEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BANKAFSCHRIFTREGEL actions', async () => {
      const arg = 42666;
