...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UITSCHRIJVING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_UITSCHRIJVING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_UITSCHRIJVING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_UITSCHRIJVING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_UITSCHRIJVING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_UITSCHRIJVING actions', async () => {
      const arg = 42666;
