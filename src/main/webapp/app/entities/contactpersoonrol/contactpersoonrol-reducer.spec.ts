...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './contactpersoonrol.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTACTPERSOONROL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CONTACTPERSOONROL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CONTACTPERSOONROL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CONTACTPERSOONROL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CONTACTPERSOONROL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CONTACTPERSOONROL actions', async () => {
      const arg = 42666;
