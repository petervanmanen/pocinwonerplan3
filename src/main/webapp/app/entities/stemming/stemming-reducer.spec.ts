...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './stemming.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STEMMING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STEMMING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STEMMING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STEMMING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STEMMING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STEMMING actions', async () => {
      const arg = 42666;
