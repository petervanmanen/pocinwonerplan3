...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DECLARATIEREGEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DECLARATIEREGEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DECLARATIEREGEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DECLARATIEREGEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DECLARATIEREGEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DECLARATIEREGEL actions', async () => {
      const arg = 42666;
