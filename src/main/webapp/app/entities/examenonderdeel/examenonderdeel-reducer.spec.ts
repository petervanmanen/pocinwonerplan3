...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXAMENONDERDEEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EXAMENONDERDEEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EXAMENONDERDEEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_EXAMENONDERDEEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_EXAMENONDERDEEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EXAMENONDERDEEL actions', async () => {
      const arg = 42666;
