...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './gemeente.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GEMEENTE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GEMEENTE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GEMEENTE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_GEMEENTE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_GEMEENTE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GEMEENTE actions', async () => {
      const arg = 42666;
