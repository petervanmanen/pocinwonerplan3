...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HUURWONINGEN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HUURWONINGEN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HUURWONINGEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HUURWONINGEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HUURWONINGEN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HUURWONINGEN actions', async () => {
      const arg = 42666;
