...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './uitlaatconstructie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UITLAATCONSTRUCTIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_UITLAATCONSTRUCTIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_UITLAATCONSTRUCTIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_UITLAATCONSTRUCTIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_UITLAATCONSTRUCTIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_UITLAATCONSTRUCTIE actions', async () => {
      const arg = 42666;
