...
import { getEntity, deleteEntity } from './documenttype.reducer';
...
export const DocumenttypeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="demo3App.documenttype.delete.question">
        Are you sure you want to delete Documenttype {documenttypeEntity.id}?
      </ModalBody>
      <ModalFooter>
