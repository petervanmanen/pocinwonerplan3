...
import { IDocumenttype, defaultValue } from 'app/shared/model/documenttype.model';
...
const apiUrl = 'api/documenttypes';

// Actions

export const getEntities = createAsyncThunk('documenttype/fetch_entity_list', async ({ sort }: IQueryParams) => {
