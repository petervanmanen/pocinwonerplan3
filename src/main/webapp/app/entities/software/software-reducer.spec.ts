...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './software.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOFTWARE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SOFTWARE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SOFTWARE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SOFTWARE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SOFTWARE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SOFTWARE actions', async () => {
      const arg = 42666;
