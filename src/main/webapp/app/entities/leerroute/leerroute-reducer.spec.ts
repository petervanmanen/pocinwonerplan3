...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './leerroute.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEERROUTE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LEERROUTE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LEERROUTE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LEERROUTE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LEERROUTE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LEERROUTE actions', async () => {
      const arg = 42666;
