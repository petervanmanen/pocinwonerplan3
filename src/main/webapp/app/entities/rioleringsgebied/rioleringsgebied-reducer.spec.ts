...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RIOLERINGSGEBIED_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RIOLERINGSGEBIED actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RIOLERINGSGEBIED actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RIOLERINGSGEBIED actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RIOLERINGSGEBIED actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RIOLERINGSGEBIED actions', async () => {
      const arg = 42666;
