...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AANBESTEDING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AANBESTEDING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AANBESTEDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AANBESTEDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AANBESTEDING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AANBESTEDING actions', async () => {
      const arg = 42666;
