...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GEBOUWDOBJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GEBOUWDOBJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GEBOUWDOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_GEBOUWDOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_GEBOUWDOBJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GEBOUWDOBJECT actions', async () => {
      const arg = 42666;
