...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HOTELBEZOEK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HOTELBEZOEK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HOTELBEZOEK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HOTELBEZOEK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HOTELBEZOEK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HOTELBEZOEK actions', async () => {
      const arg = 42666;
