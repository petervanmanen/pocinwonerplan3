          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  Betreft Museumobject <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {incidentList.map((incident, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{incident.datum ? <TextFormat type="date" value={incident.datum} format={APP_LOCAL_DATE_FORMAT} /> : null}</td>
                  <td>{incident.locatie}</td>
                  <td>{incident.naam}</td>
                  <td>{incident.omschrijving}</td>
                  <td>
                    {incident.betreftMuseumobjects
                      ? incident.betreftMuseumobjects.map((val, j) => (
                          <span key={j}>
                            <Link to={`/museumobject/${val.id}`}>{val.id}</Link>
                            {j === incident.betreftMuseumobjects.length - 1 ? '' : ', '}
                          </span>
                        ))
                      : null}
                  </td>
