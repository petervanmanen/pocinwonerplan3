...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './veld.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VELD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VELD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VELD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VELD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VELD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VELD actions', async () => {
      const arg = 42666;
