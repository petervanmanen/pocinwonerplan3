...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './reisdocumentsoort.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REISDOCUMENTSOORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REISDOCUMENTSOORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REISDOCUMENTSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_REISDOCUMENTSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_REISDOCUMENTSOORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REISDOCUMENTSOORT actions', async () => {
      const arg = 42666;
