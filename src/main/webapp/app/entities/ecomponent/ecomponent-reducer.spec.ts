...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ECOMPONENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ECOMPONENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ECOMPONENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ECOMPONENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ECOMPONENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ECOMPONENT actions', async () => {
      const arg = 42666;
