...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VERVOERSMIDDEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VERVOERSMIDDEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VERVOERSMIDDEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VERVOERSMIDDEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VERVOERSMIDDEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VERVOERSMIDDEL actions', async () => {
      const arg = 42666;
