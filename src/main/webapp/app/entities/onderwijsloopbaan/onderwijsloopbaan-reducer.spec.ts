...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './onderwijsloopbaan.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ONDERWIJSLOOPBAAN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ONDERWIJSLOOPBAAN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ONDERWIJSLOOPBAAN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ONDERWIJSLOOPBAAN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ONDERWIJSLOOPBAAN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ONDERWIJSLOOPBAAN actions', async () => {
      const arg = 42666;
