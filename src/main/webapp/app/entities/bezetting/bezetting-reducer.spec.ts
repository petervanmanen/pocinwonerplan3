...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bezetting.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BEZETTING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BEZETTING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BEZETTING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BEZETTING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BEZETTING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BEZETTING actions', async () => {
      const arg = 42666;
