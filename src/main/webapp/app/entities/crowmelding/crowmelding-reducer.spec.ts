...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CROWMELDING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CROWMELDING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CROWMELDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CROWMELDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CROWMELDING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CROWMELDING actions', async () => {
      const arg = 42666;
