...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KUNSTWERKDEEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KUNSTWERKDEEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KUNSTWERKDEEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_KUNSTWERKDEEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_KUNSTWERKDEEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KUNSTWERKDEEL actions', async () => {
      const arg = 42666;
