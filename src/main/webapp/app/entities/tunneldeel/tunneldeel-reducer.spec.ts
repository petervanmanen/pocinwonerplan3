...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TUNNELDEEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TUNNELDEEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TUNNELDEEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TUNNELDEEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TUNNELDEEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TUNNELDEEL actions', async () => {
      const arg = 42666;
