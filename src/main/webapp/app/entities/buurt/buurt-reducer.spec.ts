...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './buurt.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BUURT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BUURT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BUURT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BUURT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BUURT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BUURT actions', async () => {
      const arg = 42666;
