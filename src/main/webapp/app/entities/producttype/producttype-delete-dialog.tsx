...
import { getEntity, deleteEntity } from './producttype.reducer';
...
export const ProducttypeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="demo3App.producttype.delete.question">Are you sure you want to delete Producttype {producttypeEntity.id}?</ModalBody>
      <ModalFooter>
