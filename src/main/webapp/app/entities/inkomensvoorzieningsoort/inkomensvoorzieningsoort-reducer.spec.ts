...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './inkomensvoorzieningsoort.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INKOMENSVOORZIENINGSOORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INKOMENSVOORZIENINGSOORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INKOMENSVOORZIENINGSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INKOMENSVOORZIENINGSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INKOMENSVOORZIENINGSOORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INKOMENSVOORZIENINGSOORT actions', async () => {
      const arg = 42666;
