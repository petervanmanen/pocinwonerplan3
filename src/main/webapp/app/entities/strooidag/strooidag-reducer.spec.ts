...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './strooidag.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STROOIDAG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STROOIDAG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STROOIDAG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STROOIDAG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STROOIDAG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STROOIDAG actions', async () => {
      const arg = 42666;
