...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './informatiedakloosheid.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INFORMATIEDAKLOOSHEID_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INFORMATIEDAKLOOSHEID actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INFORMATIEDAKLOOSHEID actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INFORMATIEDAKLOOSHEID actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INFORMATIEDAKLOOSHEID actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INFORMATIEDAKLOOSHEID actions', async () => {
      const arg = 42666;
