...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BENOEMDTERREIN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BENOEMDTERREIN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BENOEMDTERREIN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BENOEMDTERREIN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BENOEMDTERREIN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BENOEMDTERREIN actions', async () => {
      const arg = 42666;
