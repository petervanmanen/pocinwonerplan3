...
import { getEntity, deleteEntity } from './locatie.reducer';

export const LocatieDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="demo3App.locatie.delete.question">Are you sure you want to delete Locatie {locatieEntity.id}?</ModalBody>
      <ModalFooter>
...
export default LocatieDeleteDialog;
