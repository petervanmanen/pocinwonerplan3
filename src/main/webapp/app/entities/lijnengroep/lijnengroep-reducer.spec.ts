...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LIJNENGROEP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LIJNENGROEP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LIJNENGROEP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LIJNENGROEP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LIJNENGROEP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LIJNENGROEP actions', async () => {
      const arg = 42666;
