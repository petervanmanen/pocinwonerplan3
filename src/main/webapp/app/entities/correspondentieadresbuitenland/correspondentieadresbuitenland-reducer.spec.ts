...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './correspondentieadresbuitenland.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CORRESPONDENTIEADRESBUITENLAND_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CORRESPONDENTIEADRESBUITENLAND actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CORRESPONDENTIEADRESBUITENLAND actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CORRESPONDENTIEADRESBUITENLAND actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CORRESPONDENTIEADRESBUITENLAND actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CORRESPONDENTIEADRESBUITENLAND actions', async () => {
      const arg = 42666;
