...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MOORMELDING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MOORMELDING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MOORMELDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MOORMELDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MOORMELDING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MOORMELDING actions', async () => {
      const arg = 42666;
