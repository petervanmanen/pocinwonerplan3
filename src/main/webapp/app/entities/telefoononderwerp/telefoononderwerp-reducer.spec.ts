...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './telefoononderwerp.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TELEFOONONDERWERP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TELEFOONONDERWERP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TELEFOONONDERWERP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TELEFOONONDERWERP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TELEFOONONDERWERP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TELEFOONONDERWERP actions', async () => {
      const arg = 42666;
