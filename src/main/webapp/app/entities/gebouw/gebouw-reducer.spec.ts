...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './gebouw.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GEBOUW_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GEBOUW actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GEBOUW actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_GEBOUW actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_GEBOUW actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GEBOUW actions', async () => {
      const arg = 42666;
