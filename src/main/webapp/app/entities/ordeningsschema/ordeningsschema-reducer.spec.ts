...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORDENINGSSCHEMA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ORDENINGSSCHEMA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ORDENINGSSCHEMA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ORDENINGSSCHEMA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ORDENINGSSCHEMA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ORDENINGSSCHEMA actions', async () => {
      const arg = 42666;
