...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './indieningsvereisten.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INDIENINGSVEREISTEN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INDIENINGSVEREISTEN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INDIENINGSVEREISTEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INDIENINGSVEREISTEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INDIENINGSVEREISTEN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INDIENINGSVEREISTEN actions', async () => {
      const arg = 42666;
