...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bouwstijl.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOUWSTIJL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BOUWSTIJL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BOUWSTIJL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BOUWSTIJL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BOUWSTIJL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BOUWSTIJL actions', async () => {
      const arg = 42666;
