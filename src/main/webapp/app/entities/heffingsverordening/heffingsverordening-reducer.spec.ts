...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './heffingsverordening.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HEFFINGSVERORDENING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HEFFINGSVERORDENING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HEFFINGSVERORDENING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HEFFINGSVERORDENING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HEFFINGSVERORDENING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HEFFINGSVERORDENING actions', async () => {
      const arg = 42666;
