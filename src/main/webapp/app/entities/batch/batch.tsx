          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  Heeftherkomst Applicatie <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {batchList.map((batch, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{batch.tijd}</td>
                  <td>
                    {batch.heeftherkomstApplicatie ? (
                      <Link to={`/applicatie/${batch.heeftherkomstApplicatie.id}`}>{batch.heeftherkomstApplicatie.id}</Link>
                    ) : (
                      ''
                    )}
                  </td>
