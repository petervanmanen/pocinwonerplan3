...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './doelgroep.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOELGROEP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DOELGROEP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DOELGROEP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DOELGROEP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DOELGROEP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DOELGROEP actions', async () => {
      const arg = 42666;
