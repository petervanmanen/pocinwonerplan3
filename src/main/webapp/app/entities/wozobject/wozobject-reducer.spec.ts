...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './wozobject.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WOZOBJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WOZOBJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WOZOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WOZOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WOZOBJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WOZOBJECT actions', async () => {
      const arg = 42666;
