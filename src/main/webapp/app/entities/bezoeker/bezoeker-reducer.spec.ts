...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bezoeker.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BEZOEKER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BEZOEKER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BEZOEKER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BEZOEKER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BEZOEKER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BEZOEKER actions', async () => {
      const arg = 42666;
