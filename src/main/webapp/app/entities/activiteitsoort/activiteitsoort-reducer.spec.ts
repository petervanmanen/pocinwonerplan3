...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACTIVITEITSOORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ACTIVITEITSOORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ACTIVITEITSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ACTIVITEITSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ACTIVITEITSOORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ACTIVITEITSOORT actions', async () => {
      const arg = 42666;
