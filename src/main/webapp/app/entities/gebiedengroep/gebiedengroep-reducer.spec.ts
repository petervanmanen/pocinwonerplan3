...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GEBIEDENGROEP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GEBIEDENGROEP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GEBIEDENGROEP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_GEBIEDENGROEP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_GEBIEDENGROEP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GEBIEDENGROEP actions', async () => {
      const arg = 42666;
