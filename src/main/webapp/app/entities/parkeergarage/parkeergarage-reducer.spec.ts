...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARKEERGARAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PARKEERGARAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PARKEERGARAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PARKEERGARAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PARKEERGARAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PARKEERGARAGE actions', async () => {
      const arg = 42666;
