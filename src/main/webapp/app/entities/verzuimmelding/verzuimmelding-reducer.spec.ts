...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VERZUIMMELDING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VERZUIMMELDING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VERZUIMMELDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VERZUIMMELDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VERZUIMMELDING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VERZUIMMELDING actions', async () => {
      const arg = 42666;
