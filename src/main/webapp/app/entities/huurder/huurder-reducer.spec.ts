...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './huurder.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HUURDER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HUURDER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HUURDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HUURDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HUURDER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HUURDER actions', async () => {
      const arg = 42666;
