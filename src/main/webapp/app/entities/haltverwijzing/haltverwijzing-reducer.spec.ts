...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HALTVERWIJZING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HALTVERWIJZING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HALTVERWIJZING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HALTVERWIJZING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HALTVERWIJZING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HALTVERWIJZING actions', async () => {
      const arg = 42666;
