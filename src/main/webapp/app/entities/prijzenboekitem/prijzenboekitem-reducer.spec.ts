...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRIJZENBOEKITEM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRIJZENBOEKITEM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRIJZENBOEKITEM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRIJZENBOEKITEM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRIJZENBOEKITEM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRIJZENBOEKITEM actions', async () => {
      const arg = 42666;
