...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RONDLEIDING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RONDLEIDING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RONDLEIDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RONDLEIDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RONDLEIDING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RONDLEIDING actions', async () => {
      const arg = 42666;
