...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './parkeervergunning.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARKEERVERGUNNING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PARKEERVERGUNNING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PARKEERVERGUNNING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PARKEERVERGUNNING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PARKEERVERGUNNING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PARKEERVERGUNNING actions', async () => {
      const arg = 42666;
