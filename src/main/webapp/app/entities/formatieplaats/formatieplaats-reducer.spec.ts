...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FORMATIEPLAATS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FORMATIEPLAATS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FORMATIEPLAATS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FORMATIEPLAATS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FORMATIEPLAATS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FORMATIEPLAATS actions', async () => {
      const arg = 42666;
