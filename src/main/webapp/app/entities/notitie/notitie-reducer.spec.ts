...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './notitie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOTITIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NOTITIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NOTITIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_NOTITIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_NOTITIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NOTITIE actions', async () => {
      const arg = 42666;
