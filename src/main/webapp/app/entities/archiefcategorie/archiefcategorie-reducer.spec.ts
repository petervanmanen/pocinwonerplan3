...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARCHIEFCATEGORIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ARCHIEFCATEGORIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ARCHIEFCATEGORIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ARCHIEFCATEGORIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ARCHIEFCATEGORIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ARCHIEFCATEGORIE actions', async () => {
      const arg = 42666;
