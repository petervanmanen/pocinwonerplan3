...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './elogboek.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ELOGBOEK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ELOGBOEK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ELOGBOEK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ELOGBOEK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ELOGBOEK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ELOGBOEK actions', async () => {
      const arg = 42666;
