...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VERKEERSLICHT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VERKEERSLICHT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VERKEERSLICHT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VERKEERSLICHT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VERKEERSLICHT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VERKEERSLICHT actions', async () => {
      const arg = 42666;
