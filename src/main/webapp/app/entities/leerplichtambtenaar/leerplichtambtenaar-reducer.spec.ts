...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './leerplichtambtenaar.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEERPLICHTAMBTENAAR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LEERPLICHTAMBTENAAR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LEERPLICHTAMBTENAAR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LEERPLICHTAMBTENAAR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LEERPLICHTAMBTENAAR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LEERPLICHTAMBTENAAR actions', async () => {
      const arg = 42666;
