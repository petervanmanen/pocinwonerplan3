...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './pip.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PIP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PIP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PIP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PIP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PIP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PIP actions', async () => {
      const arg = 42666;
