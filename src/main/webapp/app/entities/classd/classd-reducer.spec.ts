...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './classd.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLASSD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CLASSD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CLASSD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CLASSD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CLASSD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CLASSD actions', async () => {
      const arg = 42666;
