...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './sollicitatiegesprek.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOLLICITATIEGESPREK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SOLLICITATIEGESPREK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SOLLICITATIEGESPREK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SOLLICITATIEGESPREK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SOLLICITATIEGESPREK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SOLLICITATIEGESPREK actions', async () => {
      const arg = 42666;
