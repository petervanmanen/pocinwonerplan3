...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './omgevingsvergunning.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OMGEVINGSVERGUNNING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OMGEVINGSVERGUNNING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OMGEVINGSVERGUNNING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OMGEVINGSVERGUNNING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OMGEVINGSVERGUNNING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OMGEVINGSVERGUNNING actions', async () => {
      const arg = 42666;
