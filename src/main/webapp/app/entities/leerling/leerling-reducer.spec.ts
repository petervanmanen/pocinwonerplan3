...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './leerling.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEERLING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LEERLING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LEERLING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LEERLING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LEERLING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LEERLING actions', async () => {
      const arg = 42666;
