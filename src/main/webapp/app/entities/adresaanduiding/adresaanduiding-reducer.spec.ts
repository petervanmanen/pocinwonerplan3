...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADRESAANDUIDING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ADRESAANDUIDING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ADRESAANDUIDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ADRESAANDUIDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ADRESAANDUIDING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ADRESAANDUIDING actions', async () => {
      const arg = 42666;
