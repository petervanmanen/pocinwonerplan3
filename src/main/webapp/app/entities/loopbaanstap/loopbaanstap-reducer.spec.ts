...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOOPBAANSTAP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LOOPBAANSTAP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LOOPBAANSTAP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LOOPBAANSTAP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LOOPBAANSTAP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LOOPBAANSTAP actions', async () => {
      const arg = 42666;
