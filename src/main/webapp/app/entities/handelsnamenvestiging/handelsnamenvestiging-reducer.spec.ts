...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './handelsnamenvestiging.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HANDELSNAMENVESTIGING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HANDELSNAMENVESTIGING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HANDELSNAMENVESTIGING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HANDELSNAMENVESTIGING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HANDELSNAMENVESTIGING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HANDELSNAMENVESTIGING actions', async () => {
      const arg = 42666;
