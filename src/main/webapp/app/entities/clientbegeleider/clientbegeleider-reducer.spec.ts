...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLIENTBEGELEIDER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CLIENTBEGELEIDER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CLIENTBEGELEIDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CLIENTBEGELEIDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CLIENTBEGELEIDER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CLIENTBEGELEIDER actions', async () => {
      const arg = 42666;
