...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEELPROCESTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DEELPROCESTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DEELPROCESTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DEELPROCESTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DEELPROCESTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DEELPROCESTYPE actions', async () => {
      const arg = 42666;
