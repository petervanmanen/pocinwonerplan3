...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './rit.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RIT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RIT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RIT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RIT actions', async () => {
      const arg = 42666;
