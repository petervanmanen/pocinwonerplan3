...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MAATREGELEN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MAATREGELEN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MAATREGELEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MAATREGELEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MAATREGELEN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MAATREGELEN actions', async () => {
      const arg = 42666;
