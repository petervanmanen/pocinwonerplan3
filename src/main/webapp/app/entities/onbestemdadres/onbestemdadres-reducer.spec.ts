...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ONBESTEMDADRES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ONBESTEMDADRES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ONBESTEMDADRES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ONBESTEMDADRES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ONBESTEMDADRES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ONBESTEMDADRES actions', async () => {
      const arg = 42666;
