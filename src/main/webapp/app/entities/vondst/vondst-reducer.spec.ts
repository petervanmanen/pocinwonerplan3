...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './vondst.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VONDST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VONDST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VONDST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VONDST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VONDST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VONDST actions', async () => {
      const arg = 42666;
