...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './aanvraag.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AANVRAAG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AANVRAAG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AANVRAAG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AANVRAAG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AANVRAAG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AANVRAAG actions', async () => {
      const arg = 42666;
