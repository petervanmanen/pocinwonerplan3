...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RELATIESOORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RELATIESOORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RELATIESOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RELATIESOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RELATIESOORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RELATIESOORT actions', async () => {
      const arg = 42666;
