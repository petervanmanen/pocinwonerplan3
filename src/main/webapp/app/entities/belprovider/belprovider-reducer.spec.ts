...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BELPROVIDER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BELPROVIDER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BELPROVIDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BELPROVIDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BELPROVIDER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BELPROVIDER actions', async () => {
      const arg = 42666;
