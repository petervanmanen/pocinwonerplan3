...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './overstortconstructie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OVERSTORTCONSTRUCTIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OVERSTORTCONSTRUCTIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OVERSTORTCONSTRUCTIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OVERSTORTCONSTRUCTIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OVERSTORTCONSTRUCTIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OVERSTORTCONSTRUCTIE actions', async () => {
      const arg = 42666;
