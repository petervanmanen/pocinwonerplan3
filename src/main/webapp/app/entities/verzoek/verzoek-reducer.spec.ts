...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './verzoek.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VERZOEK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VERZOEK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VERZOEK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VERZOEK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VERZOEK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VERZOEK actions', async () => {
      const arg = 42666;
