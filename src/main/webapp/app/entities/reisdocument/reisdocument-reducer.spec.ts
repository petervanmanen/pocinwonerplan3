...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REISDOCUMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REISDOCUMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REISDOCUMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_REISDOCUMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_REISDOCUMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REISDOCUMENT actions', async () => {
      const arg = 42666;
