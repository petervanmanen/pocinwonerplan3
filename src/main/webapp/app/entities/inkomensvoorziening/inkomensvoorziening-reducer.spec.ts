...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './inkomensvoorziening.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INKOMENSVOORZIENING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INKOMENSVOORZIENING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INKOMENSVOORZIENING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INKOMENSVOORZIENING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INKOMENSVOORZIENING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INKOMENSVOORZIENING actions', async () => {
      const arg = 42666;
