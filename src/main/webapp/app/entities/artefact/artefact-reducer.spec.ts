...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './artefact.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARTEFACT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ARTEFACT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ARTEFACT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ARTEFACT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ARTEFACT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ARTEFACT actions', async () => {
      const arg = 42666;
