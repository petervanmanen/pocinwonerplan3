...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './redenverkrijgingnationaliteit.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REDENVERKRIJGINGNATIONALITEIT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REDENVERKRIJGINGNATIONALITEIT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REDENVERKRIJGINGNATIONALITEIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_REDENVERKRIJGINGNATIONALITEIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_REDENVERKRIJGINGNATIONALITEIT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REDENVERKRIJGINGNATIONALITEIT actions', async () => {
      const arg = 42666;
