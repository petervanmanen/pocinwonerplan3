...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './verlichtingsobject.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VERLICHTINGSOBJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VERLICHTINGSOBJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VERLICHTINGSOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VERLICHTINGSOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VERLICHTINGSOBJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VERLICHTINGSOBJECT actions', async () => {
      const arg = 42666;
