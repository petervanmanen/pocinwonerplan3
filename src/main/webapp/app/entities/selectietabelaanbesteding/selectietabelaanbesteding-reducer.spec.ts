...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './selectietabelaanbesteding.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SELECTIETABELAANBESTEDING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SELECTIETABELAANBESTEDING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SELECTIETABELAANBESTEDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SELECTIETABELAANBESTEDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SELECTIETABELAANBESTEDING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SELECTIETABELAANBESTEDING actions', async () => {
      const arg = 42666;
