...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './auteur.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AUTEUR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AUTEUR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AUTEUR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AUTEUR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AUTEUR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AUTEUR actions', async () => {
      const arg = 42666;
