...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AANTEKENING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AANTEKENING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AANTEKENING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AANTEKENING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AANTEKENING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AANTEKENING actions', async () => {
      const arg = 42666;
