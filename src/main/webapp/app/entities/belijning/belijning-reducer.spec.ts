...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './belijning.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BELIJNING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BELIJNING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BELIJNING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BELIJNING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BELIJNING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BELIJNING actions', async () => {
      const arg = 42666;
