...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VIDEOOPNAME_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VIDEOOPNAME actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VIDEOOPNAME actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VIDEOOPNAME actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VIDEOOPNAME actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VIDEOOPNAME actions', async () => {
      const arg = 42666;
