...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './zaal.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ZAAL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ZAAL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ZAAL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ZAAL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ZAAL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ZAAL actions', async () => {
      const arg = 42666;
