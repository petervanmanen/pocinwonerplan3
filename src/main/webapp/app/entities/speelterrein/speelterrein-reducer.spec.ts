...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPEELTERREIN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SPEELTERREIN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SPEELTERREIN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SPEELTERREIN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SPEELTERREIN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SPEELTERREIN actions', async () => {
      const arg = 42666;
