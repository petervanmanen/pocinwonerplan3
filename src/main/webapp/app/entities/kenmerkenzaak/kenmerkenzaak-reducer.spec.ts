...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KENMERKENZAAK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KENMERKENZAAK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KENMERKENZAAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_KENMERKENZAAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_KENMERKENZAAK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KENMERKENZAAK actions', async () => {
      const arg = 42666;
