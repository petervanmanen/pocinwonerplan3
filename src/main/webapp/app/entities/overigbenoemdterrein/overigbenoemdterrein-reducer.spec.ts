...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './overigbenoemdterrein.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OVERIGBENOEMDTERREIN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OVERIGBENOEMDTERREIN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OVERIGBENOEMDTERREIN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OVERIGBENOEMDTERREIN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OVERIGBENOEMDTERREIN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OVERIGBENOEMDTERREIN actions', async () => {
      const arg = 42666;
