...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './kwaliteitskenmerken.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KWALITEITSKENMERKEN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KWALITEITSKENMERKEN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KWALITEITSKENMERKEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_KWALITEITSKENMERKEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_KWALITEITSKENMERKEN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KWALITEITSKENMERKEN actions', async () => {
      const arg = 42666;
