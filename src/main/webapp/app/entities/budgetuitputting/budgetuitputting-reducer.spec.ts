...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BUDGETUITPUTTING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BUDGETUITPUTTING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BUDGETUITPUTTING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BUDGETUITPUTTING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BUDGETUITPUTTING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BUDGETUITPUTTING actions', async () => {
      const arg = 42666;
