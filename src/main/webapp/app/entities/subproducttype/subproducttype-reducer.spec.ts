...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBPRODUCTTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SUBPRODUCTTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SUBPRODUCTTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SUBPRODUCTTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SUBPRODUCTTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SUBPRODUCTTYPE actions', async () => {
      const arg = 42666;
