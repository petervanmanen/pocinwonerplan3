...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPORTLOCATIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SPORTLOCATIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SPORTLOCATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SPORTLOCATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SPORTLOCATIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SPORTLOCATIE actions', async () => {
      const arg = 42666;
