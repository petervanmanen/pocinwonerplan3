...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './klachtleerlingenvervoer.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KLACHTLEERLINGENVERVOER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KLACHTLEERLINGENVERVOER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KLACHTLEERLINGENVERVOER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_KLACHTLEERLINGENVERVOER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_KLACHTLEERLINGENVERVOER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KLACHTLEERLINGENVERVOER actions', async () => {
      const arg = 42666;
