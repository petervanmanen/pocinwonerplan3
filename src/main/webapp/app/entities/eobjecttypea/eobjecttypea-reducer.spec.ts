...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EOBJECTTYPEA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EOBJECTTYPEA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EOBJECTTYPEA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_EOBJECTTYPEA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_EOBJECTTYPEA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EOBJECTTYPEA actions', async () => {
      const arg = 42666;
