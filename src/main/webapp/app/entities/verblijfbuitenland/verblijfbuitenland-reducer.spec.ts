...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './verblijfbuitenland.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VERBLIJFBUITENLAND_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VERBLIJFBUITENLAND actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VERBLIJFBUITENLAND actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VERBLIJFBUITENLAND actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VERBLIJFBUITENLAND actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VERBLIJFBUITENLAND actions', async () => {
      const arg = 42666;
