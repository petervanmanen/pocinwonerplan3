...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VERLOFSOORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VERLOFSOORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VERLOFSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VERLOFSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VERLOFSOORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VERLOFSOORT actions', async () => {
      const arg = 42666;
