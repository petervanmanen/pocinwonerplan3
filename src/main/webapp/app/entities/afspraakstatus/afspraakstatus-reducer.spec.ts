...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AFSPRAAKSTATUS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AFSPRAAKSTATUS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AFSPRAAKSTATUS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AFSPRAAKSTATUS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AFSPRAAKSTATUS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AFSPRAAKSTATUS actions', async () => {
      const arg = 42666;
