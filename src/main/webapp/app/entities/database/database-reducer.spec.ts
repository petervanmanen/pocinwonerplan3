...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './database.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DATABASE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DATABASE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DATABASE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DATABASE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DATABASE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DATABASE actions', async () => {
      const arg = 42666;
