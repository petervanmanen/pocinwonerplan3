...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ECOMPONENTSOORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ECOMPONENTSOORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ECOMPONENTSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ECOMPONENTSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ECOMPONENTSOORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ECOMPONENTSOORT actions', async () => {
      const arg = 42666;
