...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './wozdeelobjectcode.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WOZDEELOBJECTCODE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WOZDEELOBJECTCODE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WOZDEELOBJECTCODE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WOZDEELOBJECTCODE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WOZDEELOBJECTCODE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WOZDEELOBJECTCODE actions', async () => {
      const arg = 42666;
