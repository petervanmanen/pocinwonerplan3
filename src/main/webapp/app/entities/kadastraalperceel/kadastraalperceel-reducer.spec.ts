...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './kadastraalperceel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KADASTRAALPERCEEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KADASTRAALPERCEEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KADASTRAALPERCEEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_KADASTRAALPERCEEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_KADASTRAALPERCEEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KADASTRAALPERCEEL actions', async () => {
      const arg = 42666;
