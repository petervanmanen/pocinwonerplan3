...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BEOORDELING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BEOORDELING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BEOORDELING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BEOORDELING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BEOORDELING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BEOORDELING actions', async () => {
      const arg = 42666;
