...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FACTUURREGEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FACTUURREGEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FACTUURREGEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FACTUURREGEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FACTUURREGEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FACTUURREGEL actions', async () => {
      const arg = 42666;
