...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './leiding.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEIDING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LEIDING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LEIDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LEIDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LEIDING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LEIDING actions', async () => {
      const arg = 42666;
