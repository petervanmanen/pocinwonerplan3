...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OMZETGROEP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OMZETGROEP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OMZETGROEP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OMZETGROEP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OMZETGROEP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OMZETGROEP actions', async () => {
      const arg = 42666;
