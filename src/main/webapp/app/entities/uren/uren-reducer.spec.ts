...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './uren.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UREN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_UREN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_UREN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_UREN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_UREN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_UREN actions', async () => {
      const arg = 42666;
