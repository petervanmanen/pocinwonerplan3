...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './geoobject.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GEOOBJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GEOOBJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GEOOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_GEOOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_GEOOBJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GEOOBJECT actions', async () => {
      const arg = 42666;
