...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJECTLOCATIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PROJECTLOCATIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PROJECTLOCATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PROJECTLOCATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PROJECTLOCATIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PROJECTLOCATIE actions', async () => {
      const arg = 42666;
