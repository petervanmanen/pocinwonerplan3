...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEDEWERKER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MEDEWERKER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MEDEWERKER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MEDEWERKER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MEDEWERKER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MEDEWERKER actions', async () => {
      const arg = 42666;
