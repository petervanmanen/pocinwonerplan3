...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './subsidieprogramma.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBSIDIEPROGRAMMA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SUBSIDIEPROGRAMMA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SUBSIDIEPROGRAMMA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SUBSIDIEPROGRAMMA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SUBSIDIEPROGRAMMA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SUBSIDIEPROGRAMMA actions', async () => {
      const arg = 42666;
