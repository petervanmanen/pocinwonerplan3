...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RECHTHEBBENDE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RECHTHEBBENDE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RECHTHEBBENDE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RECHTHEBBENDE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RECHTHEBBENDE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RECHTHEBBENDE actions', async () => {
      const arg = 42666;
