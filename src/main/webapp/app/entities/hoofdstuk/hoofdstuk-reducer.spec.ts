...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './hoofdstuk.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HOOFDSTUK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HOOFDSTUK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HOOFDSTUK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HOOFDSTUK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HOOFDSTUK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HOOFDSTUK actions', async () => {
      const arg = 42666;
