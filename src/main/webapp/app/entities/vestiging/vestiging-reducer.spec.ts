...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './vestiging.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VESTIGING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VESTIGING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VESTIGING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VESTIGING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VESTIGING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VESTIGING actions', async () => {
      const arg = 42666;
