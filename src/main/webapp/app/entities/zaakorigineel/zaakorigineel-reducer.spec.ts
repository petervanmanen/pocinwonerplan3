...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ZAAKORIGINEEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ZAAKORIGINEEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ZAAKORIGINEEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ZAAKORIGINEEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ZAAKORIGINEEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ZAAKORIGINEEL actions', async () => {
      const arg = 42666;
