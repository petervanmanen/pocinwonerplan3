...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './pvt.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PVT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PVT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PVT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PVT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PVT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PVT actions', async () => {
      const arg = 42666;
