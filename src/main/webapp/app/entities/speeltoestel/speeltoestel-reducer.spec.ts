...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPEELTOESTEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SPEELTOESTEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SPEELTOESTEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SPEELTOESTEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SPEELTOESTEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SPEELTOESTEL actions', async () => {
      const arg = 42666;
