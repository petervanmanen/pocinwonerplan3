...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VERBLIJFPLAATS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VERBLIJFPLAATS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VERBLIJFPLAATS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VERBLIJFPLAATS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VERBLIJFPLAATS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VERBLIJFPLAATS actions', async () => {
      const arg = 42666;
