...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './afwijkendcorrespondentiepostadresrol.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AFWIJKENDCORRESPONDENTIEPOSTADRESROL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AFWIJKENDCORRESPONDENTIEPOSTADRESROL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AFWIJKENDCORRESPONDENTIEPOSTADRESROL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AFWIJKENDCORRESPONDENTIEPOSTADRESROL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AFWIJKENDCORRESPONDENTIEPOSTADRESROL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AFWIJKENDCORRESPONDENTIEPOSTADRESROL actions', async () => {
      const arg = 42666;
