...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './sportpark.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPORTPARK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SPORTPARK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SPORTPARK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SPORTPARK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SPORTPARK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SPORTPARK actions', async () => {
      const arg = 42666;
