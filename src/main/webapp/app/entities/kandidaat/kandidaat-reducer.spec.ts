...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './kandidaat.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KANDIDAAT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KANDIDAAT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KANDIDAAT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_KANDIDAAT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_KANDIDAAT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KANDIDAAT actions', async () => {
      const arg = 42666;
