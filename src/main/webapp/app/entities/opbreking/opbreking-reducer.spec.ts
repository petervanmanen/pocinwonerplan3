...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './opbreking.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OPBREKING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OPBREKING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OPBREKING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OPBREKING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OPBREKING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OPBREKING actions', async () => {
      const arg = 42666;
