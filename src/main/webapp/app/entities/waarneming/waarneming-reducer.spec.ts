...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WAARNEMING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WAARNEMING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WAARNEMING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WAARNEMING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WAARNEMING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WAARNEMING actions', async () => {
      const arg = 42666;
