...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './bijzonderheidsoort.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BIJZONDERHEIDSOORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BIJZONDERHEIDSOORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BIJZONDERHEIDSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BIJZONDERHEIDSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BIJZONDERHEIDSOORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BIJZONDERHEIDSOORT actions', async () => {
      const arg = 42666;
