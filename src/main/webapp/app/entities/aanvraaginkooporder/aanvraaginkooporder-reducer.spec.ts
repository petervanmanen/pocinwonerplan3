...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './aanvraaginkooporder.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AANVRAAGINKOOPORDER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AANVRAAGINKOOPORDER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AANVRAAGINKOOPORDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AANVRAAGINKOOPORDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AANVRAAGINKOOPORDER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AANVRAAGINKOOPORDER actions', async () => {
      const arg = 42666;
