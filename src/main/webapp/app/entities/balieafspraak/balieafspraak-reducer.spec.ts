...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BALIEAFSPRAAK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BALIEAFSPRAAK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BALIEAFSPRAAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BALIEAFSPRAAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BALIEAFSPRAAK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BALIEAFSPRAAK actions', async () => {
      const arg = 42666;
