...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADRESBUITENLAND_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ADRESBUITENLAND actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ADRESBUITENLAND actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ADRESBUITENLAND actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ADRESBUITENLAND actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ADRESBUITENLAND actions', async () => {
      const arg = 42666;
