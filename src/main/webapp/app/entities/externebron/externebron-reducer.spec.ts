...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXTERNEBRON_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EXTERNEBRON actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EXTERNEBRON actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_EXTERNEBRON actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_EXTERNEBRON actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EXTERNEBRON actions', async () => {
      const arg = 42666;
