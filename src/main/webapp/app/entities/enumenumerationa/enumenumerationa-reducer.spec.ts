...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENUMENUMERATIONA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ENUMENUMERATIONA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ENUMENUMERATIONA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ENUMENUMERATIONA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ENUMENUMERATIONA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ENUMENUMERATIONA actions', async () => {
      const arg = 42666;
