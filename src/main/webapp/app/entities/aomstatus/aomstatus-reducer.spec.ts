...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './aomstatus.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AOMSTATUS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AOMSTATUS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AOMSTATUS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AOMSTATUS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AOMSTATUS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AOMSTATUS actions', async () => {
      const arg = 42666;
