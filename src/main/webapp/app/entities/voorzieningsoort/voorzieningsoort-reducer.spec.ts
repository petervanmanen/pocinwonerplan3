...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VOORZIENINGSOORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VOORZIENINGSOORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VOORZIENINGSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VOORZIENINGSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VOORZIENINGSOORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VOORZIENINGSOORT actions', async () => {
      const arg = 42666;
