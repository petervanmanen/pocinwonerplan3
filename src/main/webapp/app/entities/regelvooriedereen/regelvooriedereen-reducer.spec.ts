...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './regelvooriedereen.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REGELVOORIEDEREEN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REGELVOORIEDEREEN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REGELVOORIEDEREEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_REGELVOORIEDEREEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_REGELVOORIEDEREEN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REGELVOORIEDEREEN actions', async () => {
      const arg = 42666;
