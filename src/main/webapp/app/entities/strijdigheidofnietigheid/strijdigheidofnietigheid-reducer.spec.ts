...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './strijdigheidofnietigheid.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STRIJDIGHEIDOFNIETIGHEID_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STRIJDIGHEIDOFNIETIGHEID actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STRIJDIGHEIDOFNIETIGHEID actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STRIJDIGHEIDOFNIETIGHEID actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STRIJDIGHEIDOFNIETIGHEID actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STRIJDIGHEIDOFNIETIGHEID actions', async () => {
      const arg = 42666;
