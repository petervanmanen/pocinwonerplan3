...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HUISHOUDEN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HUISHOUDEN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HUISHOUDEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HUISHOUDEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HUISHOUDEN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HUISHOUDEN actions', async () => {
      const arg = 42666;
