...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SCHOUWRONDE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SCHOUWRONDE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SCHOUWRONDE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SCHOUWRONDE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SCHOUWRONDE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SCHOUWRONDE actions', async () => {
      const arg = 42666;
