...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STRAATSECTIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STRAATSECTIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STRAATSECTIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STRAATSECTIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STRAATSECTIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STRAATSECTIE actions', async () => {
      const arg = 42666;
