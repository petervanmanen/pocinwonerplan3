...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BIJZONDERHEID_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BIJZONDERHEID actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BIJZONDERHEID actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BIJZONDERHEID actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BIJZONDERHEID actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BIJZONDERHEID actions', async () => {
      const arg = 42666;
