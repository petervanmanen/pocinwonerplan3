...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BEVOEGDGEZAG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BEVOEGDGEZAG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BEVOEGDGEZAG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BEVOEGDGEZAG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BEVOEGDGEZAG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BEVOEGDGEZAG actions', async () => {
      const arg = 42666;
