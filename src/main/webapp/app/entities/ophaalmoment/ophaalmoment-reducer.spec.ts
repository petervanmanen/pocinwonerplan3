...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OPHAALMOMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OPHAALMOMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OPHAALMOMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OPHAALMOMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OPHAALMOMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OPHAALMOMENT actions', async () => {
      const arg = 42666;
