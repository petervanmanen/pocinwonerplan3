...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './magazijnplaatsing.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MAGAZIJNPLAATSING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MAGAZIJNPLAATSING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MAGAZIJNPLAATSING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MAGAZIJNPLAATSING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MAGAZIJNPLAATSING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MAGAZIJNPLAATSING actions', async () => {
      const arg = 42666;
