...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bord.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BORD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BORD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BORD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BORD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BORD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BORD actions', async () => {
      const arg = 42666;
