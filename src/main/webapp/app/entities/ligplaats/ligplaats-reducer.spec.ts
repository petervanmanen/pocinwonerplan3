...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ligplaats.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LIGPLAATS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LIGPLAATS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LIGPLAATS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LIGPLAATS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LIGPLAATS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LIGPLAATS actions', async () => {
      const arg = 42666;
