...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './uitvoerendeinstantie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UITVOERENDEINSTANTIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_UITVOERENDEINSTANTIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_UITVOERENDEINSTANTIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_UITVOERENDEINSTANTIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_UITVOERENDEINSTANTIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_UITVOERENDEINSTANTIE actions', async () => {
      const arg = 42666;
