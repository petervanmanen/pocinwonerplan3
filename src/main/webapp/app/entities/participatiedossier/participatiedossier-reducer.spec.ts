...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './participatiedossier.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARTICIPATIEDOSSIER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PARTICIPATIEDOSSIER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PARTICIPATIEDOSSIER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PARTICIPATIEDOSSIER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PARTICIPATIEDOSSIER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PARTICIPATIEDOSSIER actions', async () => {
      const arg = 42666;
