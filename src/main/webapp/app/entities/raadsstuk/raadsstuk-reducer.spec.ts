...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './raadsstuk.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RAADSSTUK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RAADSSTUK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RAADSSTUK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RAADSSTUK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RAADSSTUK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RAADSSTUK actions', async () => {
      const arg = 42666;
