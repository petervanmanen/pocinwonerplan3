...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TUNNELOBJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TUNNELOBJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TUNNELOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TUNNELOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TUNNELOBJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TUNNELOBJECT actions', async () => {
      const arg = 42666;
