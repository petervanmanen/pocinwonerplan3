...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './beperkingscategorie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BEPERKINGSCATEGORIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BEPERKINGSCATEGORIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BEPERKINGSCATEGORIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BEPERKINGSCATEGORIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BEPERKINGSCATEGORIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BEPERKINGSCATEGORIE actions', async () => {
      const arg = 42666;
