...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GENERALISATIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GENERALISATIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GENERALISATIE actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_GENERALISATIE actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_GENERALISATIE actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_GENERALISATIE actions', async () => {
      const arg = 42666;
