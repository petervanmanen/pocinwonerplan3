...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './individueelkeuzebudget.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INDIVIDUEELKEUZEBUDGET_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INDIVIDUEELKEUZEBUDGET actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INDIVIDUEELKEUZEBUDGET actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INDIVIDUEELKEUZEBUDGET actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INDIVIDUEELKEUZEBUDGET actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INDIVIDUEELKEUZEBUDGET actions', async () => {
      const arg = 42666;
