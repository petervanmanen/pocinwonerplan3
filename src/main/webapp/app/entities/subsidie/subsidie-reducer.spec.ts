...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './subsidie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBSIDIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SUBSIDIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SUBSIDIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SUBSIDIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SUBSIDIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SUBSIDIE actions', async () => {
      const arg = 42666;
