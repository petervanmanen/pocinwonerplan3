...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VERGADERING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VERGADERING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VERGADERING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VERGADERING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VERGADERING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VERGADERING actions', async () => {
      const arg = 42666;
