...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ZAKELIJKRECHT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ZAKELIJKRECHT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ZAKELIJKRECHT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ZAKELIJKRECHT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ZAKELIJKRECHT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ZAKELIJKRECHT actions', async () => {
      const arg = 42666;
