...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './verblijfbuitenlandsubject.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VERBLIJFBUITENLANDSUBJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VERBLIJFBUITENLANDSUBJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VERBLIJFBUITENLANDSUBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VERBLIJFBUITENLANDSUBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VERBLIJFBUITENLANDSUBJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VERBLIJFBUITENLANDSUBJECT actions', async () => {
      const arg = 42666;
