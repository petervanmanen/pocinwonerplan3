...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './formulierverlenginginhuur.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FORMULIERVERLENGINGINHUUR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FORMULIERVERLENGINGINHUUR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FORMULIERVERLENGINGINHUUR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FORMULIERVERLENGINGINHUUR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FORMULIERVERLENGINGINHUUR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FORMULIERVERLENGINGINHUUR actions', async () => {
      const arg = 42666;
