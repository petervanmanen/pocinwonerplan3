...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './onbegroeidterreindeel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ONBEGROEIDTERREINDEEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ONBEGROEIDTERREINDEEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ONBEGROEIDTERREINDEEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ONBEGROEIDTERREINDEEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ONBEGROEIDTERREINDEEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ONBEGROEIDTERREINDEEL actions', async () => {
      const arg = 42666;
