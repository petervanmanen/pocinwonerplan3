...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './gebouwinstallatie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GEBOUWINSTALLATIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GEBOUWINSTALLATIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GEBOUWINSTALLATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_GEBOUWINSTALLATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_GEBOUWINSTALLATIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GEBOUWINSTALLATIE actions', async () => {
      const arg = 42666;
