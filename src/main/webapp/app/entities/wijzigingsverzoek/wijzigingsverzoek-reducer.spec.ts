...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './wijzigingsverzoek.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WIJZIGINGSVERZOEK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WIJZIGINGSVERZOEK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WIJZIGINGSVERZOEK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WIJZIGINGSVERZOEK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WIJZIGINGSVERZOEK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WIJZIGINGSVERZOEK actions', async () => {
      const arg = 42666;
