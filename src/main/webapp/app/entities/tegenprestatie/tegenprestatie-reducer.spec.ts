...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TEGENPRESTATIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TEGENPRESTATIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TEGENPRESTATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TEGENPRESTATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TEGENPRESTATIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TEGENPRESTATIE actions', async () => {
      const arg = 42666;
