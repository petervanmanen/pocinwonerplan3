...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJECTSOORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PROJECTSOORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PROJECTSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PROJECTSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PROJECTSOORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PROJECTSOORT actions', async () => {
      const arg = 42666;
