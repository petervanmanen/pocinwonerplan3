...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOLLICITANT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SOLLICITANT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SOLLICITANT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SOLLICITANT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SOLLICITANT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SOLLICITANT actions', async () => {
      const arg = 42666;
