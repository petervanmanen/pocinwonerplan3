...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './doos.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOOS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DOOS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DOOS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DOOS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DOOS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DOOS actions', async () => {
      const arg = 42666;
