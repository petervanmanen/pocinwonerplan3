...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VERVOERDER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VERVOERDER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VERVOERDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VERVOERDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VERVOERDER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VERVOERDER actions', async () => {
      const arg = 42666;
