...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './waterdeel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WATERDEEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WATERDEEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WATERDEEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WATERDEEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WATERDEEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WATERDEEL actions', async () => {
      const arg = 42666;
