...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './dossier.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOSSIER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DOSSIER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DOSSIER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DOSSIER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DOSSIER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DOSSIER actions', async () => {
      const arg = 42666;
