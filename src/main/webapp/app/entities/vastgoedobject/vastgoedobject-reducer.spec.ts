...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VASTGOEDOBJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VASTGOEDOBJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VASTGOEDOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VASTGOEDOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VASTGOEDOBJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VASTGOEDOBJECT actions', async () => {
      const arg = 42666;
