...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './classb.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLASSB_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CLASSB actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CLASSB actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CLASSB actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CLASSB actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CLASSB actions', async () => {
      const arg = 42666;
