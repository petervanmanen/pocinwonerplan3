...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './begroting.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BEGROTING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BEGROTING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BEGROTING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BEGROTING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BEGROTING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BEGROTING actions', async () => {
      const arg = 42666;
