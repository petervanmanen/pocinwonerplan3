...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRIJSREGEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRIJSREGEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRIJSREGEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRIJSREGEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRIJSREGEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRIJSREGEL actions', async () => {
      const arg = 42666;
