...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './gemeentebegrafenis.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GEMEENTEBEGRAFENIS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GEMEENTEBEGRAFENIS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GEMEENTEBEGRAFENIS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_GEMEENTEBEGRAFENIS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_GEMEENTEBEGRAFENIS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GEMEENTEBEGRAFENIS actions', async () => {
      const arg = 42666;
