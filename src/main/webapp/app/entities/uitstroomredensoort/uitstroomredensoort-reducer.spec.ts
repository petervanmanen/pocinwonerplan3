...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './uitstroomredensoort.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UITSTROOMREDENSOORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_UITSTROOMREDENSOORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_UITSTROOMREDENSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_UITSTROOMREDENSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_UITSTROOMREDENSOORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_UITSTROOMREDENSOORT actions', async () => {
      const arg = 42666;
