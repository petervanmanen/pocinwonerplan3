...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './naamgebruiknatuurlijkpersoon.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NAAMGEBRUIKNATUURLIJKPERSOON_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NAAMGEBRUIKNATUURLIJKPERSOON actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NAAMGEBRUIKNATUURLIJKPERSOON actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_NAAMGEBRUIKNATUURLIJKPERSOON actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_NAAMGEBRUIKNATUURLIJKPERSOON actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NAAMGEBRUIKNATUURLIJKPERSOON actions', async () => {
      const arg = 42666;
