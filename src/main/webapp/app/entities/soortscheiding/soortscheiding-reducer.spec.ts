...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOORTSCHEIDING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SOORTSCHEIDING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SOORTSCHEIDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SOORTSCHEIDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SOORTSCHEIDING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SOORTSCHEIDING actions', async () => {
      const arg = 42666;
