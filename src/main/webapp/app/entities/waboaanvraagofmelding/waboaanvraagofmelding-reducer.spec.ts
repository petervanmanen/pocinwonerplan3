...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './waboaanvraagofmelding.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WABOAANVRAAGOFMELDING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WABOAANVRAAGOFMELDING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WABOAANVRAAGOFMELDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WABOAANVRAAGOFMELDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WABOAANVRAAGOFMELDING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WABOAANVRAAGOFMELDING actions', async () => {
      const arg = 42666;
