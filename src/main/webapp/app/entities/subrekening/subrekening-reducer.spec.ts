...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBREKENING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SUBREKENING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SUBREKENING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SUBREKENING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SUBREKENING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SUBREKENING actions', async () => {
      const arg = 42666;
