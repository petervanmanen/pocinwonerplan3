...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INBURGERAAR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INBURGERAAR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INBURGERAAR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INBURGERAAR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INBURGERAAR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INBURGERAAR actions', async () => {
      const arg = 42666;
