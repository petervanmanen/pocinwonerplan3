...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOORTGROOTTE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SOORTGROOTTE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SOORTGROOTTE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SOORTGROOTTE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SOORTGROOTTE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SOORTGROOTTE actions', async () => {
      const arg = 42666;
