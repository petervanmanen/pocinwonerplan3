...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTGROEP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUCTGROEP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUCTGROEP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRODUCTGROEP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTGROEP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRODUCTGROEP actions', async () => {
      const arg = 42666;
