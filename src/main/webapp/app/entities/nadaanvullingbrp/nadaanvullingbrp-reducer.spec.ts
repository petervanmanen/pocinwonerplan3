...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NADAANVULLINGBRP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NADAANVULLINGBRP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NADAANVULLINGBRP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_NADAANVULLINGBRP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_NADAANVULLINGBRP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NADAANVULLINGBRP actions', async () => {
      const arg = 42666;
