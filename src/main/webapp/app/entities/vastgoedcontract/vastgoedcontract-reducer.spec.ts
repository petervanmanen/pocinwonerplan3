...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VASTGOEDCONTRACT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VASTGOEDCONTRACT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VASTGOEDCONTRACT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VASTGOEDCONTRACT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VASTGOEDCONTRACT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VASTGOEDCONTRACT actions', async () => {
      const arg = 42666;
