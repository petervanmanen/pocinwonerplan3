...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './aanbestedingvastgoed.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AANBESTEDINGVASTGOED_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AANBESTEDINGVASTGOED actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AANBESTEDINGVASTGOED actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AANBESTEDINGVASTGOED actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AANBESTEDINGVASTGOED actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AANBESTEDINGVASTGOED actions', async () => {
      const arg = 42666;
