...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEELPROCES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DEELPROCES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DEELPROCES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DEELPROCES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DEELPROCES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DEELPROCES actions', async () => {
      const arg = 42666;
