...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UITKERINGSRUN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_UITKERINGSRUN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_UITKERINGSRUN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_UITKERINGSRUN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_UITKERINGSRUN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_UITKERINGSRUN actions', async () => {
      const arg = 42666;
