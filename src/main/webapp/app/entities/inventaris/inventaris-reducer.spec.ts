...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INVENTARIS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INVENTARIS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INVENTARIS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INVENTARIS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INVENTARIS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INVENTARIS actions', async () => {
      const arg = 42666;
