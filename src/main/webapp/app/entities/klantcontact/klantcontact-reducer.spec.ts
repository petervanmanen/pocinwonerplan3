...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KLANTCONTACT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KLANTCONTACT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KLANTCONTACT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_KLANTCONTACT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_KLANTCONTACT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KLANTCONTACT actions', async () => {
      const arg = 42666;
