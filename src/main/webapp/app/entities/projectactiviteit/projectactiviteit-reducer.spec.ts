...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './projectactiviteit.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJECTACTIVITEIT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PROJECTACTIVITEIT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PROJECTACTIVITEIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PROJECTACTIVITEIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PROJECTACTIVITEIT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PROJECTACTIVITEIT actions', async () => {
      const arg = 42666;
