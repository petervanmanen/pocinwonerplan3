...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EOBJECTTYPEE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EOBJECTTYPEE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EOBJECTTYPEE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_EOBJECTTYPEE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_EOBJECTTYPEE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EOBJECTTYPEE actions', async () => {
      const arg = 42666;
