...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VERLOFAANVRAAG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VERLOFAANVRAAG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VERLOFAANVRAAG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VERLOFAANVRAAG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VERLOFAANVRAAG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VERLOFAANVRAAG actions', async () => {
      const arg = 42666;
