...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './cultuurcodebebouwd.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CULTUURCODEBEBOUWD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CULTUURCODEBEBOUWD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CULTUURCODEBEBOUWD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CULTUURCODEBEBOUWD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CULTUURCODEBEBOUWD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CULTUURCODEBEBOUWD actions', async () => {
      const arg = 42666;
