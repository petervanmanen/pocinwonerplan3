...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './epackage.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EPACKAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EPACKAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EPACKAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_EPACKAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_EPACKAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EPACKAGE actions', async () => {
      const arg = 42666;
