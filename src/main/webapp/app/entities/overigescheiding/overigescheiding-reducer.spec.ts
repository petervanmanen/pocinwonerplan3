...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OVERIGESCHEIDING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OVERIGESCHEIDING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OVERIGESCHEIDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OVERIGESCHEIDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OVERIGESCHEIDING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OVERIGESCHEIDING actions', async () => {
      const arg = 42666;
