...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './storting.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STORTING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STORTING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STORTING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STORTING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STORTING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STORTING actions', async () => {
      const arg = 42666;
