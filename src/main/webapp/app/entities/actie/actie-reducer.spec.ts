...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './actie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACTIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ACTIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ACTIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ACTIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ACTIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ACTIE actions', async () => {
      const arg = 42666;
