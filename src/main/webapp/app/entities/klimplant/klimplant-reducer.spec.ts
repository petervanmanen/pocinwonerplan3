...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './klimplant.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KLIMPLANT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KLIMPLANT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KLIMPLANT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_KLIMPLANT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_KLIMPLANT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KLIMPLANT actions', async () => {
      const arg = 42666;
