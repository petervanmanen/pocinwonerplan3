...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './lener.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LENER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LENER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LENER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LENER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LENER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LENER actions', async () => {
      const arg = 42666;
