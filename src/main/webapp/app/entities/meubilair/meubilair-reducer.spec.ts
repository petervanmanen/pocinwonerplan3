...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './meubilair.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEUBILAIR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MEUBILAIR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MEUBILAIR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MEUBILAIR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MEUBILAIR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MEUBILAIR actions', async () => {
      const arg = 42666;
