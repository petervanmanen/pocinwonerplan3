...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSCHRIJVING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INSCHRIJVING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INSCHRIJVING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INSCHRIJVING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INSCHRIJVING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INSCHRIJVING actions', async () => {
      const arg = 42666;
