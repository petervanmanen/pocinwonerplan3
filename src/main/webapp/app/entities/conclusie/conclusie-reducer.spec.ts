...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './conclusie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONCLUSIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CONCLUSIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CONCLUSIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CONCLUSIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CONCLUSIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CONCLUSIE actions', async () => {
      const arg = 42666;
