...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NORMPROFIEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NORMPROFIEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NORMPROFIEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_NORMPROFIEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_NORMPROFIEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NORMPROFIEL actions', async () => {
      const arg = 42666;
