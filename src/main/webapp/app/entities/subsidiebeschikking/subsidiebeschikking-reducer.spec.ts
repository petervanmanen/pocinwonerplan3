...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './subsidiebeschikking.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBSIDIEBESCHIKKING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SUBSIDIEBESCHIKKING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SUBSIDIEBESCHIKKING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SUBSIDIEBESCHIKKING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SUBSIDIEBESCHIKKING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SUBSIDIEBESCHIKKING actions', async () => {
      const arg = 42666;
