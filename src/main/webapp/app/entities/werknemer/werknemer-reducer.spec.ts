...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './werknemer.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WERKNEMER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WERKNEMER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WERKNEMER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WERKNEMER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WERKNEMER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WERKNEMER actions', async () => {
      const arg = 42666;
