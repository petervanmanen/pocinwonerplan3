...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INITIATIEFNEMER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INITIATIEFNEMER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INITIATIEFNEMER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INITIATIEFNEMER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INITIATIEFNEMER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INITIATIEFNEMER actions', async () => {
      const arg = 42666;
