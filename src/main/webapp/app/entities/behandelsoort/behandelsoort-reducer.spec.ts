...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BEHANDELSOORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BEHANDELSOORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BEHANDELSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BEHANDELSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BEHANDELSOORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BEHANDELSOORT actions', async () => {
      const arg = 42666;
