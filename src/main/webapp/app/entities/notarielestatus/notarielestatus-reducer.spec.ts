...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOTARIELESTATUS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NOTARIELESTATUS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NOTARIELESTATUS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_NOTARIELESTATUS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_NOTARIELESTATUS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NOTARIELESTATUS actions', async () => {
      const arg = 42666;
