...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BEHEEROBJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BEHEEROBJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BEHEEROBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BEHEEROBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BEHEEROBJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BEHEEROBJECT actions', async () => {
      const arg = 42666;
