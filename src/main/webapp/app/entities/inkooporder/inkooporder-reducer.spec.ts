...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INKOOPORDER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INKOOPORDER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INKOOPORDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INKOOPORDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INKOOPORDER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INKOOPORDER actions', async () => {
      const arg = 42666;
