...
export const ServerDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="demo3App.server.delete.question">Are you sure you want to delete Server {serverEntity.id}?</ModalBody>
      <ModalFooter>
        <Button color="secondary" onClick={handleClose}>
          <FontAwesomeIcon icon="ban" />
          &nbsp; Cancel
        </Button>
        <Button id="jhi-confirm-delete-server" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
