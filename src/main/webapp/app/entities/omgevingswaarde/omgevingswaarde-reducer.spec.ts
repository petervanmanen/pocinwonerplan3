...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OMGEVINGSWAARDE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OMGEVINGSWAARDE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OMGEVINGSWAARDE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OMGEVINGSWAARDE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OMGEVINGSWAARDE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OMGEVINGSWAARDE actions', async () => {
      const arg = 42666;
