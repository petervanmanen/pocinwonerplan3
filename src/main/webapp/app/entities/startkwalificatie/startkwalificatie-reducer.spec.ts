...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './startkwalificatie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STARTKWALIFICATIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STARTKWALIFICATIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STARTKWALIFICATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STARTKWALIFICATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STARTKWALIFICATIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STARTKWALIFICATIE actions', async () => {
      const arg = 42666;
