...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EOBJECTTYPEC_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EOBJECTTYPEC actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EOBJECTTYPEC actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_EOBJECTTYPEC actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_EOBJECTTYPEC actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EOBJECTTYPEC actions', async () => {
      const arg = 42666;
