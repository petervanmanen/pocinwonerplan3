...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SAMENSTELLER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SAMENSTELLER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SAMENSTELLER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SAMENSTELLER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SAMENSTELLER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SAMENSTELLER actions', async () => {
      const arg = 42666;
