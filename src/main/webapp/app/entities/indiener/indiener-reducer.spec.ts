...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './indiener.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INDIENER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INDIENER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INDIENER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INDIENER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INDIENER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INDIENER actions', async () => {
      const arg = 42666;
