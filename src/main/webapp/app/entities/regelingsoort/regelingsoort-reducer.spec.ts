...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REGELINGSOORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REGELINGSOORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REGELINGSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_REGELINGSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_REGELINGSOORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REGELINGSOORT actions', async () => {
      const arg = 42666;
