...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HEFFINGGRONDSLAG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HEFFINGGRONDSLAG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HEFFINGGRONDSLAG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HEFFINGGRONDSLAG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HEFFINGGRONDSLAG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HEFFINGGRONDSLAG actions', async () => {
      const arg = 42666;
