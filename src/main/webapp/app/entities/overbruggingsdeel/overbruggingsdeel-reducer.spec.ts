...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './overbruggingsdeel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OVERBRUGGINGSDEEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OVERBRUGGINGSDEEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OVERBRUGGINGSDEEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OVERBRUGGINGSDEEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OVERBRUGGINGSDEEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OVERBRUGGINGSDEEL actions', async () => {
      const arg = 42666;
