...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './redenverliesnationaliteit.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REDENVERLIESNATIONALITEIT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REDENVERLIESNATIONALITEIT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REDENVERLIESNATIONALITEIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_REDENVERLIESNATIONALITEIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_REDENVERLIESNATIONALITEIT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REDENVERLIESNATIONALITEIT actions', async () => {
      const arg = 42666;
