...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NUMMERAANDUIDING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NUMMERAANDUIDING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NUMMERAANDUIDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_NUMMERAANDUIDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_NUMMERAANDUIDING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NUMMERAANDUIDING actions', async () => {
      const arg = 42666;
