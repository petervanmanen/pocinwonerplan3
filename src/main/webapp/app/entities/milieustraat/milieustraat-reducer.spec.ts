...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MILIEUSTRAAT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MILIEUSTRAAT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MILIEUSTRAAT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MILIEUSTRAAT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MILIEUSTRAAT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MILIEUSTRAAT actions', async () => {
      const arg = 42666;
