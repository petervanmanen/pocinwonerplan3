...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOEWIJZING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TOEWIJZING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TOEWIJZING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TOEWIJZING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TOEWIJZING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TOEWIJZING actions', async () => {
      const arg = 42666;
