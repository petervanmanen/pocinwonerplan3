...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KLANTBEOORDELING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KLANTBEOORDELING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KLANTBEOORDELING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_KLANTBEOORDELING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_KLANTBEOORDELING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KLANTBEOORDELING actions', async () => {
      const arg = 42666;
