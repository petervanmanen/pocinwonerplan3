...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VORDERINGREGEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VORDERINGREGEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VORDERINGREGEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VORDERINGREGEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VORDERINGREGEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VORDERINGREGEL actions', async () => {
      const arg = 42666;
