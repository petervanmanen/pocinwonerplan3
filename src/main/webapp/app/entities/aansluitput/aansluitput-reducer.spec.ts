...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AANSLUITPUT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AANSLUITPUT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AANSLUITPUT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AANSLUITPUT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AANSLUITPUT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AANSLUITPUT actions', async () => {
      const arg = 42666;
