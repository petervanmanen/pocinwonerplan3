...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './vulling.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VULLING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VULLING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VULLING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VULLING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VULLING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VULLING actions', async () => {
      const arg = 42666;
