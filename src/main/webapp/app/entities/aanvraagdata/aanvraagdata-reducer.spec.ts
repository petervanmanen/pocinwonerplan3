...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AANVRAAGDATA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AANVRAAGDATA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AANVRAAGDATA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AANVRAAGDATA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AANVRAAGDATA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AANVRAAGDATA actions', async () => {
      const arg = 42666;
