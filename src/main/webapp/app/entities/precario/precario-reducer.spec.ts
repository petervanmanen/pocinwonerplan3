...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './precario.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRECARIO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRECARIO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRECARIO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRECARIO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRECARIO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRECARIO actions', async () => {
      const arg = 42666;
