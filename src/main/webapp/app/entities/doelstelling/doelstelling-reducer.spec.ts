...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOELSTELLING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DOELSTELLING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DOELSTELLING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DOELSTELLING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DOELSTELLING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DOELSTELLING actions', async () => {
      const arg = 42666;
