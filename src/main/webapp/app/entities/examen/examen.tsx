    ...
    <div>
      ...
      <div className="table-responsive">
        {examenList && examenList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  Afgerondmet Inburgeringstraject <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {examenList.map((examen, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {examen.afgerondmetInburgeringstraject ? (
                      <Link to={`/inburgeringstraject/${examen.afgerondmetInburgeringstraject.id}`}>
                        {examen.afgerondmetInburgeringstraject.id}
                      </Link>
                    ) : (
                      ''
                    )}
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        onClick={() => (window.location.href = `/examen/${examen.id}/delete`)}
                        color="danger"
                        size="sm"
          ...
          !loading && <div className="alert alert-warning">No Examen found</div>
        )}
      </div>
    </div>
  );
