...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BESCHIKKING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BESCHIKKING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BESCHIKKING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BESCHIKKING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BESCHIKKING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BESCHIKKING actions', async () => {
      const arg = 42666;
