...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './putdeksel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PUTDEKSEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PUTDEKSEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PUTDEKSEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PUTDEKSEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PUTDEKSEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PUTDEKSEL actions', async () => {
      const arg = 42666;
