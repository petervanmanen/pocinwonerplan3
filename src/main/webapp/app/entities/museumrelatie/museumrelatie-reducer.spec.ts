...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MUSEUMRELATIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MUSEUMRELATIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MUSEUMRELATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MUSEUMRELATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MUSEUMRELATIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MUSEUMRELATIE actions', async () => {
      const arg = 42666;
