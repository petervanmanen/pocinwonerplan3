...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './klantbeoordelingreden.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KLANTBEOORDELINGREDEN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KLANTBEOORDELINGREDEN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KLANTBEOORDELINGREDEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_KLANTBEOORDELINGREDEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_KLANTBEOORDELINGREDEN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KLANTBEOORDELINGREDEN actions', async () => {
      const arg = 42666;
