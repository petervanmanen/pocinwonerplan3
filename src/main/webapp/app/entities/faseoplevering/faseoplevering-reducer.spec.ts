...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FASEOPLEVERING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FASEOPLEVERING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FASEOPLEVERING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FASEOPLEVERING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FASEOPLEVERING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FASEOPLEVERING actions', async () => {
      const arg = 42666;
