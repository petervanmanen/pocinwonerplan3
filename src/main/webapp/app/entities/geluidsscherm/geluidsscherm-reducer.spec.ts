...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GELUIDSSCHERM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GELUIDSSCHERM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GELUIDSSCHERM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_GELUIDSSCHERM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_GELUIDSSCHERM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GELUIDSSCHERM actions', async () => {
      const arg = 42666;
