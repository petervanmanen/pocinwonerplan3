...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './beperking.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BEPERKING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BEPERKING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BEPERKING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BEPERKING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BEPERKING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BEPERKING actions', async () => {
      const arg = 42666;
