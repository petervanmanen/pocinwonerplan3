...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOUWACTIVITEIT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BOUWACTIVITEIT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BOUWACTIVITEIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BOUWACTIVITEIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BOUWACTIVITEIT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BOUWACTIVITEIT actions', async () => {
      const arg = 42666;
