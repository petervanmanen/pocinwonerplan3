...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './taak.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TAAK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TAAK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TAAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TAAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TAAK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TAAK actions', async () => {
      const arg = 42666;
