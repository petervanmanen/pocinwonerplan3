...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './mutatie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MUTATIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MUTATIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MUTATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MUTATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MUTATIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MUTATIE actions', async () => {
      const arg = 42666;
