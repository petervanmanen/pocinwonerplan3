...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BENOEMDOBJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BENOEMDOBJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BENOEMDOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BENOEMDOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BENOEMDOBJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BENOEMDOBJECT actions', async () => {
      const arg = 42666;
