...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BESLISSING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BESLISSING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BESLISSING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BESLISSING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BESLISSING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BESLISSING actions', async () => {
      const arg = 42666;
