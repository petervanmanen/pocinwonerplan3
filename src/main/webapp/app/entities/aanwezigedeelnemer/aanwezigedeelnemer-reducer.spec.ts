...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './aanwezigedeelnemer.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AANWEZIGEDEELNEMER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AANWEZIGEDEELNEMER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AANWEZIGEDEELNEMER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AANWEZIGEDEELNEMER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AANWEZIGEDEELNEMER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AANWEZIGEDEELNEMER actions', async () => {
      const arg = 42666;
