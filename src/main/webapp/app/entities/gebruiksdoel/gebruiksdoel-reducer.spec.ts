...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GEBRUIKSDOEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GEBRUIKSDOEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GEBRUIKSDOEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_GEBRUIKSDOEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_GEBRUIKSDOEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GEBRUIKSDOEL actions', async () => {
      const arg = 42666;
