...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './voertuig.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VOERTUIG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VOERTUIG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VOERTUIG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VOERTUIG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VOERTUIG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VOERTUIG actions', async () => {
      const arg = 42666;
