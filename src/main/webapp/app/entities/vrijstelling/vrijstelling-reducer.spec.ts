...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VRIJSTELLING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VRIJSTELLING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VRIJSTELLING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VRIJSTELLING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VRIJSTELLING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VRIJSTELLING actions', async () => {
      const arg = 42666;
