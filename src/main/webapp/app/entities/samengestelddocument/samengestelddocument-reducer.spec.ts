...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './samengestelddocument.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SAMENGESTELDDOCUMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SAMENGESTELDDOCUMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SAMENGESTELDDOCUMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SAMENGESTELDDOCUMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SAMENGESTELDDOCUMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SAMENGESTELDDOCUMENT actions', async () => {
      const arg = 42666;
