...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VALUTASOORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VALUTASOORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VALUTASOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VALUTASOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VALUTASOORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VALUTASOORT actions', async () => {
      const arg = 42666;
