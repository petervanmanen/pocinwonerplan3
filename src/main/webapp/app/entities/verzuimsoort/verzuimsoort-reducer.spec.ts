...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VERZUIMSOORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VERZUIMSOORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VERZUIMSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VERZUIMSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VERZUIMSOORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VERZUIMSOORT actions', async () => {
      const arg = 42666;
