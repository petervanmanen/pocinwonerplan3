...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './beperkingscoresoort.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BEPERKINGSCORESOORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BEPERKINGSCORESOORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BEPERKINGSCORESOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BEPERKINGSCORESOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BEPERKINGSCORESOORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BEPERKINGSCORESOORT actions', async () => {
      const arg = 42666;
