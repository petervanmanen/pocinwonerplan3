...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BETAALMOMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BETAALMOMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BETAALMOMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BETAALMOMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BETAALMOMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BETAALMOMENT actions', async () => {
      const arg = 42666;
