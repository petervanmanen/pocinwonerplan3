...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARCHIEFSTUK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ARCHIEFSTUK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ARCHIEFSTUK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ARCHIEFSTUK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ARCHIEFSTUK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ARCHIEFSTUK actions', async () => {
      const arg = 42666;
