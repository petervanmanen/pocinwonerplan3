...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './depot.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEPOT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DEPOT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DEPOT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DEPOT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DEPOT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DEPOT actions', async () => {
      const arg = 42666;
