...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './beschiktevoorziening.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BESCHIKTEVOORZIENING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BESCHIKTEVOORZIENING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BESCHIKTEVOORZIENING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BESCHIKTEVOORZIENING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BESCHIKTEVOORZIENING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BESCHIKTEVOORZIENING actions', async () => {
      const arg = 42666;
