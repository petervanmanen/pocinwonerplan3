...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './prijs.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRIJS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRIJS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRIJS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRIJS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRIJS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRIJS actions', async () => {
      const arg = 42666;
