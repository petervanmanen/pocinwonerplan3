...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './classc.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLASSC_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CLASSC actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CLASSC actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CLASSC actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CLASSC actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CLASSC actions', async () => {
      const arg = 42666;
