...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VOORZIENING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VOORZIENING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VOORZIENING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VOORZIENING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VOORZIENING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VOORZIENING actions', async () => {
      const arg = 42666;
