...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOUWDEELELEMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BOUWDEELELEMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BOUWDEELELEMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BOUWDEELELEMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BOUWDEELELEMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BOUWDEELELEMENT actions', async () => {
      const arg = 42666;
