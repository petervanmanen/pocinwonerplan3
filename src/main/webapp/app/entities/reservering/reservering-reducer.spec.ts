...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESERVERING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RESERVERING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RESERVERING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RESERVERING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RESERVERING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RESERVERING actions', async () => {
      const arg = 42666;
