...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './openbareactiviteit.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OPENBAREACTIVITEIT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OPENBAREACTIVITEIT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OPENBAREACTIVITEIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OPENBAREACTIVITEIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OPENBAREACTIVITEIT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OPENBAREACTIVITEIT actions', async () => {
      const arg = 42666;
