...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './collectie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COLLECTIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COLLECTIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COLLECTIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_COLLECTIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_COLLECTIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COLLECTIE actions', async () => {
      const arg = 42666;
