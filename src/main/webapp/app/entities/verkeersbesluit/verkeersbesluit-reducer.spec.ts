...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VERKEERSBESLUIT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VERKEERSBESLUIT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VERKEERSBESLUIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VERKEERSBESLUIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VERKEERSBESLUIT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VERKEERSBESLUIT actions', async () => {
      const arg = 42666;
