...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './organisatorischeeenheidhr.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORGANISATORISCHEEENHEIDHR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ORGANISATORISCHEEENHEIDHR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ORGANISATORISCHEEENHEIDHR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ORGANISATORISCHEEENHEIDHR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ORGANISATORISCHEEENHEIDHR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ORGANISATORISCHEEENHEIDHR actions', async () => {
      const arg = 42666;
