...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './aommeldingwmojeugd.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AOMMELDINGWMOJEUGD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AOMMELDINGWMOJEUGD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AOMMELDINGWMOJEUGD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AOMMELDINGWMOJEUGD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AOMMELDINGWMOJEUGD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AOMMELDINGWMOJEUGD actions', async () => {
      const arg = 42666;
