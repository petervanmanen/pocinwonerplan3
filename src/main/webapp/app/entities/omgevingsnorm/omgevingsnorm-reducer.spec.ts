...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OMGEVINGSNORM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OMGEVINGSNORM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OMGEVINGSNORM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OMGEVINGSNORM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OMGEVINGSNORM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OMGEVINGSNORM actions', async () => {
      const arg = 42666;
