...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UITSTROOMREDEN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_UITSTROOMREDEN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_UITSTROOMREDEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_UITSTROOMREDEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_UITSTROOMREDEN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_UITSTROOMREDEN actions', async () => {
      const arg = 42666;
