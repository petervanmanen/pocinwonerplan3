...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEIDINGELEMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LEIDINGELEMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LEIDINGELEMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LEIDINGELEMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LEIDINGELEMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LEIDINGELEMENT actions', async () => {
      const arg = 42666;
