...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './regeling.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REGELING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REGELING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REGELING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_REGELING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_REGELING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REGELING actions', async () => {
      const arg = 42666;
