...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './leerjaar.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEERJAAR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LEERJAAR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LEERJAAR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LEERJAAR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LEERJAAR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LEERJAAR actions', async () => {
      const arg = 42666;
