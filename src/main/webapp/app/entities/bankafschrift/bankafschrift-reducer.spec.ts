...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANKAFSCHRIFT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BANKAFSCHRIFT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BANKAFSCHRIFT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BANKAFSCHRIFT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BANKAFSCHRIFT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BANKAFSCHRIFT actions', async () => {
      const arg = 42666;
