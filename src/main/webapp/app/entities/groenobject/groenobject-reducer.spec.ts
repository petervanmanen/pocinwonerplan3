...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GROENOBJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GROENOBJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GROENOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_GROENOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_GROENOBJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GROENOBJECT actions', async () => {
      const arg = 42666;
