...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './uitgever.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UITGEVER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_UITGEVER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_UITGEVER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_UITGEVER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_UITGEVER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_UITGEVER actions', async () => {
      const arg = 42666;
