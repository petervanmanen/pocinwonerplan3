...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SCORESOORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SCORESOORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SCORESOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SCORESOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SCORESOORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SCORESOORT actions', async () => {
      const arg = 42666;
