...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './studentenwoningen.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STUDENTENWONINGEN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STUDENTENWONINGEN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STUDENTENWONINGEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STUDENTENWONINGEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STUDENTENWONINGEN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STUDENTENWONINGEN actions', async () => {
      const arg = 42666;
