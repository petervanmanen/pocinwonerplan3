...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './asielstatushouder.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ASIELSTATUSHOUDER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ASIELSTATUSHOUDER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ASIELSTATUSHOUDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ASIELSTATUSHOUDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ASIELSTATUSHOUDER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ASIELSTATUSHOUDER actions', async () => {
      const arg = 42666;
