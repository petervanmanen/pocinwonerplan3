...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ERFGOEDOBJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ERFGOEDOBJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ERFGOEDOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ERFGOEDOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ERFGOEDOBJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ERFGOEDOBJECT actions', async () => {
      const arg = 42666;
