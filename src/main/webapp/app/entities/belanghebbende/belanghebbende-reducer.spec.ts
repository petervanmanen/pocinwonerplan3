...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BELANGHEBBENDE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BELANGHEBBENDE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BELANGHEBBENDE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BELANGHEBBENDE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BELANGHEBBENDE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BELANGHEBBENDE actions', async () => {
      const arg = 42666;
