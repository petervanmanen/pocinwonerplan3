...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BEHANDELING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BEHANDELING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BEHANDELING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BEHANDELING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BEHANDELING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BEHANDELING actions', async () => {
      const arg = 42666;
