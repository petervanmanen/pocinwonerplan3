...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bouwtype.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOUWTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BOUWTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BOUWTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BOUWTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BOUWTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BOUWTYPE actions', async () => {
      const arg = 42666;
