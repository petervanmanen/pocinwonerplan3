...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOORTWOZOBJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SOORTWOZOBJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SOORTWOZOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SOORTWOZOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SOORTWOZOBJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SOORTWOZOBJECT actions', async () => {
      const arg = 42666;
