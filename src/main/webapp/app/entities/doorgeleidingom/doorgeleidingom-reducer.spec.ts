...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOORGELEIDINGOM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DOORGELEIDINGOM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DOORGELEIDINGOM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DOORGELEIDINGOM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DOORGELEIDINGOM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DOORGELEIDINGOM actions', async () => {
      const arg = 42666;
