...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './ziekmeldingleerlingenvervoer.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ZIEKMELDINGLEERLINGENVERVOER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ZIEKMELDINGLEERLINGENVERVOER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ZIEKMELDINGLEERLINGENVERVOER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ZIEKMELDINGLEERLINGENVERVOER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ZIEKMELDINGLEERLINGENVERVOER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ZIEKMELDINGLEERLINGENVERVOER actions', async () => {
      const arg = 42666;
