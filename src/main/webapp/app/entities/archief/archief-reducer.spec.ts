...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './archief.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARCHIEF_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ARCHIEF actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ARCHIEF actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ARCHIEF actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ARCHIEF actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ARCHIEF actions', async () => {
      const arg = 42666;
