...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ZEKERHEIDSRECHT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ZEKERHEIDSRECHT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ZEKERHEIDSRECHT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ZEKERHEIDSRECHT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ZEKERHEIDSRECHT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ZEKERHEIDSRECHT actions', async () => {
      const arg = 42666;
