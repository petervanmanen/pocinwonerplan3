...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './keermuur.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KEERMUUR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KEERMUUR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KEERMUUR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_KEERMUUR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_KEERMUUR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KEERMUUR actions', async () => {
      const arg = 42666;
