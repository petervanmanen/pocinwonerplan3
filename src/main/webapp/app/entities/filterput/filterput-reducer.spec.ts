...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './filterput.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FILTERPUT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FILTERPUT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FILTERPUT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FILTERPUT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FILTERPUT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FILTERPUT actions', async () => {
      const arg = 42666;
