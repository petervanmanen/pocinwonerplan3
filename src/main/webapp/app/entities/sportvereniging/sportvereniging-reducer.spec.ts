...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPORTVERENIGING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SPORTVERENIGING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SPORTVERENIGING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SPORTVERENIGING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SPORTVERENIGING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SPORTVERENIGING actions', async () => {
      const arg = 42666;
