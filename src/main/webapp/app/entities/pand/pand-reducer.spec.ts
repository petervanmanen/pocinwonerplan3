...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './pand.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAND_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PAND actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PAND actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PAND actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PAND actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PAND actions', async () => {
      const arg = 42666;
