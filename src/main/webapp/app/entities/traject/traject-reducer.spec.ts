...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './traject.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRAJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRAJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRAJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TRAJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TRAJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TRAJECT actions', async () => {
      const arg = 42666;
