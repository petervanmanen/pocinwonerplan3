...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IDEALISATIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_IDEALISATIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_IDEALISATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_IDEALISATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_IDEALISATIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_IDEALISATIE actions', async () => {
      const arg = 42666;
