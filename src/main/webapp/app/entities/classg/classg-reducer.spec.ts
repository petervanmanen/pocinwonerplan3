...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './classg.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLASSG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CLASSG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CLASSG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CLASSG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CLASSG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CLASSG actions', async () => {
      const arg = 42666;
