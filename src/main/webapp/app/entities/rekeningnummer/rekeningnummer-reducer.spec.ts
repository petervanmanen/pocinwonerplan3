...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REKENINGNUMMER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REKENINGNUMMER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REKENINGNUMMER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_REKENINGNUMMER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_REKENINGNUMMER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REKENINGNUMMER actions', async () => {
      const arg = 42666;
