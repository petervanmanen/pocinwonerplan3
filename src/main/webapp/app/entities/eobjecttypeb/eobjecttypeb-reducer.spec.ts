...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EOBJECTTYPEB_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EOBJECTTYPEB actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EOBJECTTYPEB actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_EOBJECTTYPEB actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_EOBJECTTYPEB actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EOBJECTTYPEB actions', async () => {
      const arg = 42666;
