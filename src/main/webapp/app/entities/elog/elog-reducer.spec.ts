...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './elog.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ELOG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ELOG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ELOG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ELOG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ELOG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ELOG actions', async () => {
      const arg = 42666;
