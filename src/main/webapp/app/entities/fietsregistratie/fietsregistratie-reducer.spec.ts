...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FIETSREGISTRATIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FIETSREGISTRATIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FIETSREGISTRATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FIETSREGISTRATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FIETSREGISTRATIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FIETSREGISTRATIE actions', async () => {
      const arg = 42666;
