...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BERGINGSBASSIN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BERGINGSBASSIN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BERGINGSBASSIN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BERGINGSBASSIN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BERGINGSBASSIN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BERGINGSBASSIN actions', async () => {
      const arg = 42666;
