...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './oorspronkelijkefunctie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OORSPRONKELIJKEFUNCTIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OORSPRONKELIJKEFUNCTIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OORSPRONKELIJKEFUNCTIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OORSPRONKELIJKEFUNCTIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OORSPRONKELIJKEFUNCTIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OORSPRONKELIJKEFUNCTIE actions', async () => {
      const arg = 42666;
