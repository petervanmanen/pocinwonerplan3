...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './datatype.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DATATYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DATATYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DATATYPE actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_DATATYPE actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_DATATYPE actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_DATATYPE actions', async () => {
      const arg = 42666;
