...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './handelsnamenmaatschappelijkeactiviteit.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HANDELSNAMENMAATSCHAPPELIJKEACTIVITEIT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HANDELSNAMENMAATSCHAPPELIJKEACTIVITEIT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HANDELSNAMENMAATSCHAPPELIJKEACTIVITEIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HANDELSNAMENMAATSCHAPPELIJKEACTIVITEIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HANDELSNAMENMAATSCHAPPELIJKEACTIVITEIT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HANDELSNAMENMAATSCHAPPELIJKEACTIVITEIT actions', async () => {
      const arg = 42666;
