...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './eobjectclassificatie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EOBJECTCLASSIFICATIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EOBJECTCLASSIFICATIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EOBJECTCLASSIFICATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_EOBJECTCLASSIFICATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_EOBJECTCLASSIFICATIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EOBJECTCLASSIFICATIE actions', async () => {
      const arg = 42666;
