...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './brug.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BRUG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BRUG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BRUG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BRUG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BRUG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BRUG actions', async () => {
      const arg = 42666;
