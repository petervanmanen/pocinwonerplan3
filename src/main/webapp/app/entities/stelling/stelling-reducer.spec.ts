...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './stelling.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STELLING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STELLING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STELLING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STELLING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STELLING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STELLING actions', async () => {
      const arg = 42666;
