...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LINKBAARCMDBITEM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LINKBAARCMDBITEM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LINKBAARCMDBITEM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LINKBAARCMDBITEM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LINKBAARCMDBITEM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LINKBAARCMDBITEM actions', async () => {
      const arg = 42666;
