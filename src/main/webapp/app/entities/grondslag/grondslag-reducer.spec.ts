...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './grondslag.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GRONDSLAG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GRONDSLAG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GRONDSLAG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_GRONDSLAG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_GRONDSLAG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GRONDSLAG actions', async () => {
      const arg = 42666;
