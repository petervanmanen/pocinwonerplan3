...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './gebied.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GEBIED_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GEBIED actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GEBIED actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_GEBIED actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_GEBIED actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GEBIED actions', async () => {
      const arg = 42666;
