...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './valuta.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VALUTA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VALUTA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VALUTA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VALUTA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VALUTA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VALUTA actions', async () => {
      const arg = 42666;
