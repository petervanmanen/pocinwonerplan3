...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './identificatiekenmerk.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IDENTIFICATIEKENMERK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_IDENTIFICATIEKENMERK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_IDENTIFICATIEKENMERK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_IDENTIFICATIEKENMERK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_IDENTIFICATIEKENMERK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_IDENTIFICATIEKENMERK actions', async () => {
      const arg = 42666;
