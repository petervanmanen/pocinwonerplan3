...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REDENBEEINDIGING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REDENBEEINDIGING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REDENBEEINDIGING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_REDENBEEINDIGING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_REDENBEEINDIGING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REDENBEEINDIGING actions', async () => {
      const arg = 42666;
