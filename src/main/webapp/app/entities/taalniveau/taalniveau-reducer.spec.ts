...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TAALNIVEAU_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TAALNIVEAU actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TAALNIVEAU actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TAALNIVEAU actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TAALNIVEAU actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TAALNIVEAU actions', async () => {
      const arg = 42666;
