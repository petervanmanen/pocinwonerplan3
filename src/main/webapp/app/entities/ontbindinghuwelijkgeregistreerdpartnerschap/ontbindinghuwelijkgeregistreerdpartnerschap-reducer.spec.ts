...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './ontbindinghuwelijkgeregistreerdpartnerschap.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ONTBINDINGHUWELIJKGEREGISTREERDPARTNERSCHAP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ONTBINDINGHUWELIJKGEREGISTREERDPARTNERSCHAP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ONTBINDINGHUWELIJKGEREGISTREERDPARTNERSCHAP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ONTBINDINGHUWELIJKGEREGISTREERDPARTNERSCHAP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ONTBINDINGHUWELIJKGEREGISTREERDPARTNERSCHAP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ONTBINDINGHUWELIJKGEREGISTREERDPARTNERSCHAP actions', async () => {
      const arg = 42666;
