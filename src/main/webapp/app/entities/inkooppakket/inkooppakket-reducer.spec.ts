...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INKOOPPAKKET_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INKOOPPAKKET actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INKOOPPAKKET actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INKOOPPAKKET actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INKOOPPAKKET actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INKOOPPAKKET actions', async () => {
      const arg = 42666;
