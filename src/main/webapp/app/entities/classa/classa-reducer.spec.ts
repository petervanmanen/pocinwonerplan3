...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './classa.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLASSA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CLASSA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CLASSA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CLASSA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CLASSA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CLASSA actions', async () => {
      const arg = 42666;
