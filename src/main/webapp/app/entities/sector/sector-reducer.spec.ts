...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './sector.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SECTOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SECTOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SECTOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SECTOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SECTOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SECTOR actions', async () => {
      const arg = 42666;
