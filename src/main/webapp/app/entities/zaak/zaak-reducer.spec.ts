...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './zaak.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ZAAK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ZAAK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ZAAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ZAAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ZAAK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ZAAK actions', async () => {
      const arg = 42666;
