...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './projectontwikkelaar.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJECTONTWIKKELAAR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PROJECTONTWIKKELAAR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PROJECTONTWIKKELAAR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PROJECTONTWIKKELAAR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PROJECTONTWIKKELAAR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PROJECTONTWIKKELAAR actions', async () => {
      const arg = 42666;
