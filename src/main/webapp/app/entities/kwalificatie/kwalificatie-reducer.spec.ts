...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KWALIFICATIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KWALIFICATIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KWALIFICATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_KWALIFICATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_KWALIFICATIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KWALIFICATIE actions', async () => {
      const arg = 42666;
