...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './mast.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MAST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MAST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MAST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MAST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MAST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MAST actions', async () => {
      const arg = 42666;
