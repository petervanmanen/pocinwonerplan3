...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOEGANGSMIDDEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TOEGANGSMIDDEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TOEGANGSMIDDEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TOEGANGSMIDDEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TOEGANGSMIDDEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TOEGANGSMIDDEL actions', async () => {
      const arg = 42666;
