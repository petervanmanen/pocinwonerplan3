...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './mjop.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MJOP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MJOP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MJOP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MJOP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MJOP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MJOP actions', async () => {
      const arg = 42666;
