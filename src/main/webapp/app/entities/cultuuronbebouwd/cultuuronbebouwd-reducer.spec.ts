...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CULTUURONBEBOUWD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CULTUURONBEBOUWD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CULTUURONBEBOUWD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CULTUURONBEBOUWD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CULTUURONBEBOUWD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CULTUURONBEBOUWD actions', async () => {
      const arg = 42666;
