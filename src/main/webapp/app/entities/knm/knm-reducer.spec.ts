...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './knm.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KNM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KNM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KNM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_KNM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_KNM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KNM actions', async () => {
      const arg = 42666;
