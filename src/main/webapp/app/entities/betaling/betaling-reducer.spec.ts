...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './betaling.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BETALING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BETALING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BETALING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BETALING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BETALING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BETALING actions', async () => {
      const arg = 42666;
