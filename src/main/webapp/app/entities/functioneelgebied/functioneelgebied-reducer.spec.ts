...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './functioneelgebied.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FUNCTIONEELGEBIED_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FUNCTIONEELGEBIED actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FUNCTIONEELGEBIED actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FUNCTIONEELGEBIED actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FUNCTIONEELGEBIED actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FUNCTIONEELGEBIED actions', async () => {
      const arg = 42666;
