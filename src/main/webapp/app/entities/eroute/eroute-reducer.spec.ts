...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './eroute.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EROUTE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EROUTE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EROUTE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_EROUTE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_EROUTE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EROUTE actions', async () => {
      const arg = 42666;
