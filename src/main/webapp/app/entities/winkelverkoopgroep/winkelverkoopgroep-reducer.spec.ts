...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './winkelverkoopgroep.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WINKELVERKOOPGROEP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WINKELVERKOOPGROEP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WINKELVERKOOPGROEP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WINKELVERKOOPGROEP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WINKELVERKOOPGROEP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WINKELVERKOOPGROEP actions', async () => {
      const arg = 42666;
