...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './locatiekadastraleonroerendezaak.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOCATIEKADASTRALEONROERENDEZAAK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LOCATIEKADASTRALEONROERENDEZAAK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LOCATIEKADASTRALEONROERENDEZAAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LOCATIEKADASTRALEONROERENDEZAAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LOCATIEKADASTRALEONROERENDEZAAK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LOCATIEKADASTRALEONROERENDEZAAK actions', async () => {
      const arg = 42666;
