...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CASEAANMELDING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CASEAANMELDING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CASEAANMELDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CASEAANMELDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CASEAANMELDING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CASEAANMELDING actions', async () => {
      const arg = 42666;
