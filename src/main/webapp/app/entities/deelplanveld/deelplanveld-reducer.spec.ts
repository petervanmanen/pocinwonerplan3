...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEELPLANVELD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DEELPLANVELD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DEELPLANVELD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DEELPLANVELD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DEELPLANVELD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DEELPLANVELD actions', async () => {
      const arg = 42666;
