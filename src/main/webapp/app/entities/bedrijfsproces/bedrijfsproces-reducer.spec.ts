...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BEDRIJFSPROCES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BEDRIJFSPROCES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BEDRIJFSPROCES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BEDRIJFSPROCES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BEDRIJFSPROCES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BEDRIJFSPROCES actions', async () => {
      const arg = 42666;
