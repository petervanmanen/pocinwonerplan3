...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './archeologiebesluit.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARCHEOLOGIEBESLUIT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ARCHEOLOGIEBESLUIT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ARCHEOLOGIEBESLUIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ARCHEOLOGIEBESLUIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ARCHEOLOGIEBESLUIT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ARCHEOLOGIEBESLUIT actions', async () => {
      const arg = 42666;
