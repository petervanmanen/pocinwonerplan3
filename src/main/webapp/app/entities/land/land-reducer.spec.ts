...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './land.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LAND_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LAND actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LAND actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LAND actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LAND actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LAND actions', async () => {
      const arg = 42666;
