...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KOOPWONINGEN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KOOPWONINGEN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KOOPWONINGEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_KOOPWONINGEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_KOOPWONINGEN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KOOPWONINGEN actions', async () => {
      const arg = 42666;
