...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOMEINOFTAAKVELD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DOMEINOFTAAKVELD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DOMEINOFTAAKVELD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DOMEINOFTAAKVELD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DOMEINOFTAAKVELD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DOMEINOFTAAKVELD actions', async () => {
      const arg = 42666;
