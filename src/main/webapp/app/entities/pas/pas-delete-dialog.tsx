...
export const PasDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(pasEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="demo3App.pas.delete.question">Are you sure you want to delete Pas {pasEntity.id}?</ModalBody>
      <ModalFooter>
...
export default PasDeleteDialog;
