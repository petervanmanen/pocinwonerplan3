...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './pas.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PAS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PAS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PAS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PAS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PAS actions', async () => {
      const arg = 42666;
