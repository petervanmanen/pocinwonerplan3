...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GEBRUIKERROL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GEBRUIKERROL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GEBRUIKERROL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_GEBRUIKERROL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_GEBRUIKERROL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GEBRUIKERROL actions', async () => {
      const arg = 42666;
