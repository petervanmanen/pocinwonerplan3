...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './afwijkendbuitenlandscorrespondentieadresrol.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AFWIJKENDBUITENLANDSCORRESPONDENTIEADRESROL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AFWIJKENDBUITENLANDSCORRESPONDENTIEADRESROL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AFWIJKENDBUITENLANDSCORRESPONDENTIEADRESROL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AFWIJKENDBUITENLANDSCORRESPONDENTIEADRESROL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AFWIJKENDBUITENLANDSCORRESPONDENTIEADRESROL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AFWIJKENDBUITENLANDSCORRESPONDENTIEADRESROL actions', async () => {
      const arg = 42666;
