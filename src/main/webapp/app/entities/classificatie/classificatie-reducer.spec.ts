...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLASSIFICATIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CLASSIFICATIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CLASSIFICATIE actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_CLASSIFICATIE actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_CLASSIFICATIE actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_CLASSIFICATIE actions', async () => {
      const arg = 42666;
