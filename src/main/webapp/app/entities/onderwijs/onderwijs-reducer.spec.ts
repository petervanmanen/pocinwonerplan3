...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './onderwijs.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ONDERWIJS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ONDERWIJS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ONDERWIJS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ONDERWIJS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ONDERWIJS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ONDERWIJS actions', async () => {
      const arg = 42666;
