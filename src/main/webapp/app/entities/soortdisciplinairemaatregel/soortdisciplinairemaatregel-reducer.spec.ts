...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './soortdisciplinairemaatregel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOORTDISCIPLINAIREMAATREGEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SOORTDISCIPLINAIREMAATREGEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SOORTDISCIPLINAIREMAATREGEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SOORTDISCIPLINAIREMAATREGEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SOORTDISCIPLINAIREMAATREGEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SOORTDISCIPLINAIREMAATREGEL actions', async () => {
      const arg = 42666;
