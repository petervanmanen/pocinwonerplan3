...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './akrkadastralegemeentecode.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AKRKADASTRALEGEMEENTECODE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AKRKADASTRALEGEMEENTECODE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AKRKADASTRALEGEMEENTECODE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AKRKADASTRALEGEMEENTECODE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AKRKADASTRALEGEMEENTECODE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AKRKADASTRALEGEMEENTECODE actions', async () => {
      const arg = 42666;
