...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRIJZENBOEK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRIJZENBOEK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRIJZENBOEK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRIJZENBOEK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRIJZENBOEK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRIJZENBOEK actions', async () => {
      const arg = 42666;
