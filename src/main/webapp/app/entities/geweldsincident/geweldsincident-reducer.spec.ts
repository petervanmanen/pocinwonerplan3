...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GEWELDSINCIDENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GEWELDSINCIDENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GEWELDSINCIDENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_GEWELDSINCIDENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_GEWELDSINCIDENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GEWELDSINCIDENT actions', async () => {
      const arg = 42666;
