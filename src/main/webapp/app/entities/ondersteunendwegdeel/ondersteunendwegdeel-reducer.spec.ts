...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './ondersteunendwegdeel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ONDERSTEUNENDWEGDEEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ONDERSTEUNENDWEGDEEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ONDERSTEUNENDWEGDEEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ONDERSTEUNENDWEGDEEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ONDERSTEUNENDWEGDEEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ONDERSTEUNENDWEGDEEL actions', async () => {
      const arg = 42666;
