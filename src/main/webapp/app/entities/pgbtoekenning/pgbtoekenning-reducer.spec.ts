...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PGBTOEKENNING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PGBTOEKENNING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PGBTOEKENNING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PGBTOEKENNING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PGBTOEKENNING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PGBTOEKENNING actions', async () => {
      const arg = 42666;
