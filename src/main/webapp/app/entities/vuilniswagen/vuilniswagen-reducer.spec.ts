...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VUILNISWAGEN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VUILNISWAGEN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VUILNISWAGEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VUILNISWAGEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VUILNISWAGEN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VUILNISWAGEN actions', async () => {
      const arg = 42666;
