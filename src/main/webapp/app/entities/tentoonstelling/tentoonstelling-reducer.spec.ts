...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TENTOONSTELLING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TENTOONSTELLING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TENTOONSTELLING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TENTOONSTELLING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TENTOONSTELLING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TENTOONSTELLING actions', async () => {
      const arg = 42666;
