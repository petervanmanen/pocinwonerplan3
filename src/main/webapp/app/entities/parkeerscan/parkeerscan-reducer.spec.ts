...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARKEERSCAN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PARKEERSCAN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PARKEERSCAN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PARKEERSCAN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PARKEERSCAN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PARKEERSCAN actions', async () => {
      const arg = 42666;
