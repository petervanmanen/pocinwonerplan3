...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VERKEERSTELLING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VERKEERSTELLING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VERKEERSTELLING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VERKEERSTELLING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VERKEERSTELLING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VERKEERSTELLING actions', async () => {
      const arg = 42666;
