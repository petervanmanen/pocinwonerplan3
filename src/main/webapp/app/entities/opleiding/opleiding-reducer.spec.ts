...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './opleiding.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OPLEIDING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OPLEIDING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OPLEIDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OPLEIDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OPLEIDING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OPLEIDING actions', async () => {
      const arg = 42666;
