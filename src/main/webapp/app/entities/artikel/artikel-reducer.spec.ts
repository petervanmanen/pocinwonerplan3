...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './artikel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARTIKEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ARTIKEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ARTIKEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ARTIKEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ARTIKEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ARTIKEL actions', async () => {
      const arg = 42666;
