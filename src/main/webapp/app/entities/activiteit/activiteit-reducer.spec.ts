...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACTIVITEIT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ACTIVITEIT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ACTIVITEIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ACTIVITEIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ACTIVITEIT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ACTIVITEIT actions', async () => {
      const arg = 42666;
