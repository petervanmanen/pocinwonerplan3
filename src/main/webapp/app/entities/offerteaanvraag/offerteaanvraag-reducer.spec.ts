...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OFFERTEAANVRAAG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OFFERTEAANVRAAG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OFFERTEAANVRAAG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OFFERTEAANVRAAG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OFFERTEAANVRAAG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OFFERTEAANVRAAG actions', async () => {
      const arg = 42666;
