...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches CREATE_STATUSTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STATUSTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STATUSTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STATUSTYPE actions', async () => {
      const arg = 42666;
