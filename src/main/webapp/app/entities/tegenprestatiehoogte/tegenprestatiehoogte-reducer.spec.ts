...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './tegenprestatiehoogte.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TEGENPRESTATIEHOOGTE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TEGENPRESTATIEHOOGTE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TEGENPRESTATIEHOOGTE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TEGENPRESTATIEHOOGTE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TEGENPRESTATIEHOOGTE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TEGENPRESTATIEHOOGTE actions', async () => {
      const arg = 42666;
