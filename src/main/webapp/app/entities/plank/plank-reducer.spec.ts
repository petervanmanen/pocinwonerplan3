...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './plank.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLANK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PLANK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PLANK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PLANK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PLANK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PLANK actions', async () => {
      const arg = 42666;
