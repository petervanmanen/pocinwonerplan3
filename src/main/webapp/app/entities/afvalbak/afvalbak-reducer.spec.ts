...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './afvalbak.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AFVALBAK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AFVALBAK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AFVALBAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AFVALBAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AFVALBAK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AFVALBAK actions', async () => {
      const arg = 42666;
