...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './indeling.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INDELING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INDELING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INDELING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INDELING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INDELING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INDELING actions', async () => {
      const arg = 42666;
