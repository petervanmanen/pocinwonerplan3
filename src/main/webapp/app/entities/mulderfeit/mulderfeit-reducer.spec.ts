...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MULDERFEIT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MULDERFEIT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MULDERFEIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MULDERFEIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MULDERFEIT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MULDERFEIT actions', async () => {
      const arg = 42666;
