...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TERREINDEEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TERREINDEEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TERREINDEEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TERREINDEEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TERREINDEEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TERREINDEEL actions', async () => {
      const arg = 42666;
