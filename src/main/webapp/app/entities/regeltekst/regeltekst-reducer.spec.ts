...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REGELTEKST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REGELTEKST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REGELTEKST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_REGELTEKST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_REGELTEKST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REGELTEKST actions', async () => {
      const arg = 42666;
