...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WATEROBJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WATEROBJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WATEROBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WATEROBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WATEROBJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WATEROBJECT actions', async () => {
      const arg = 42666;
