...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './onderwerp.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ONDERWERP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ONDERWERP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ONDERWERP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ONDERWERP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ONDERWERP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ONDERWERP actions', async () => {
      const arg = 42666;
