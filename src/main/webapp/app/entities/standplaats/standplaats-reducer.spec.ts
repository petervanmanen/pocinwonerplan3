...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STANDPLAATS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STANDPLAATS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STANDPLAATS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STANDPLAATS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STANDPLAATS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STANDPLAATS actions', async () => {
      const arg = 42666;
