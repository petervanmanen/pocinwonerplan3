...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bedrijf.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BEDRIJF_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BEDRIJF actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BEDRIJF actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BEDRIJF actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BEDRIJF actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BEDRIJF actions', async () => {
      const arg = 42666;
