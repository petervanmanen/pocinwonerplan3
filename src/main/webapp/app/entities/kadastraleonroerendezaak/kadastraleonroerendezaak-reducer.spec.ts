...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './kadastraleonroerendezaak.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KADASTRALEONROERENDEZAAK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KADASTRALEONROERENDEZAAK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KADASTRALEONROERENDEZAAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_KADASTRALEONROERENDEZAAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_KADASTRALEONROERENDEZAAK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KADASTRALEONROERENDEZAAK actions', async () => {
      const arg = 42666;
