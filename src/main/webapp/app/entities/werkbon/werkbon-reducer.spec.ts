...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './werkbon.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WERKBON_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WERKBON actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WERKBON actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WERKBON actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WERKBON actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WERKBON actions', async () => {
      const arg = 42666;
