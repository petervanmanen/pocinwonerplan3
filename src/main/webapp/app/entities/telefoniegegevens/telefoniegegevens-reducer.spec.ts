...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './telefoniegegevens.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TELEFONIEGEGEVENS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TELEFONIEGEGEVENS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TELEFONIEGEGEVENS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TELEFONIEGEGEVENS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TELEFONIEGEGEVENS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TELEFONIEGEGEVENS actions', async () => {
      const arg = 42666;
