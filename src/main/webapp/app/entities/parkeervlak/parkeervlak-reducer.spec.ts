...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARKEERVLAK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PARKEERVLAK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PARKEERVLAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PARKEERVLAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PARKEERVLAK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PARKEERVLAK actions', async () => {
      const arg = 42666;
