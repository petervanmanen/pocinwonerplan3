...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './sociaalteamdossiersoort.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOCIAALTEAMDOSSIERSOORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SOCIAALTEAMDOSSIERSOORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SOCIAALTEAMDOSSIERSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SOCIAALTEAMDOSSIERSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SOCIAALTEAMDOSSIERSOORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SOCIAALTEAMDOSSIERSOORT actions', async () => {
      const arg = 42666;
