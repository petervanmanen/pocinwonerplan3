...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ambacht.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AMBACHT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AMBACHT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AMBACHT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AMBACHT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AMBACHT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AMBACHT actions', async () => {
      const arg = 42666;
