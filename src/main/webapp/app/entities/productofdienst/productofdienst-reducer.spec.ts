...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTOFDIENST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUCTOFDIENST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUCTOFDIENST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRODUCTOFDIENST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTOFDIENST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRODUCTOFDIENST actions', async () => {
      const arg = 42666;
