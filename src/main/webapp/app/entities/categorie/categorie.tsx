          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  Gekwalificeerd Leverancier <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {categorieList.map((categorie, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {categorie.gekwalificeerdLeveranciers
                      ? categorie.gekwalificeerdLeveranciers.map((val, j) => (
                          <span key={j}>
                            <Link to={`/leverancier/${val.id}`}>{val.id}</Link>
                            {j === categorie.gekwalificeerdLeveranciers.length - 1 ? '' : ', '}
                          </span>
                        ))
                      : null}
                  </td>
