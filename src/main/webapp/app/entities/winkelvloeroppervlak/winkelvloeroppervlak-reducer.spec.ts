...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './winkelvloeroppervlak.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WINKELVLOEROPPERVLAK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WINKELVLOEROPPERVLAK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WINKELVLOEROPPERVLAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WINKELVLOEROPPERVLAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WINKELVLOEROPPERVLAK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WINKELVLOEROPPERVLAK actions', async () => {
      const arg = 42666;
