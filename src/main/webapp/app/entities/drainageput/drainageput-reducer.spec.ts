...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DRAINAGEPUT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DRAINAGEPUT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DRAINAGEPUT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DRAINAGEPUT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DRAINAGEPUT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DRAINAGEPUT actions', async () => {
      const arg = 42666;
