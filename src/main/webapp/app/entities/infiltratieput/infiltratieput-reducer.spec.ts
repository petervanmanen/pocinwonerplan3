...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INFILTRATIEPUT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INFILTRATIEPUT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INFILTRATIEPUT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INFILTRATIEPUT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INFILTRATIEPUT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INFILTRATIEPUT actions', async () => {
      const arg = 42666;
