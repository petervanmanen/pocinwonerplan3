...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DECLARATIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DECLARATIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DECLARATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DECLARATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DECLARATIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DECLARATIE actions', async () => {
      const arg = 42666;
