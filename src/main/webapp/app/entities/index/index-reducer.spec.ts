...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './index.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INDEX_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INDEX actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INDEX actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INDEX actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INDEX actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INDEX actions', async () => {
      const arg = 42666;
