...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VERBLIJFSTITEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VERBLIJFSTITEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VERBLIJFSTITEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VERBLIJFSTITEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VERBLIJFSTITEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VERBLIJFSTITEL actions', async () => {
      const arg = 42666;
