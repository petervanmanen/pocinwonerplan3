...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BEPERKINGSGEBIED_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BEPERKINGSGEBIED actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BEPERKINGSGEBIED actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BEPERKINGSGEBIED actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BEPERKINGSGEBIED actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BEPERKINGSGEBIED actions', async () => {
      const arg = 42666;
