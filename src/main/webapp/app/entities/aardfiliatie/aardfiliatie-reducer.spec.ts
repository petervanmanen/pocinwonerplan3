...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AARDFILIATIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AARDFILIATIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AARDFILIATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AARDFILIATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AARDFILIATIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AARDFILIATIE actions', async () => {
      const arg = 42666;
