...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './combibon.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMBIBON_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COMBIBON actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COMBIBON actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_COMBIBON actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_COMBIBON actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COMBIBON actions', async () => {
      const arg = 42666;
