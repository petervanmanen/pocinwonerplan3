...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './beschikkingleerlingenvervoer.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BESCHIKKINGLEERLINGENVERVOER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BESCHIKKINGLEERLINGENVERVOER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BESCHIKKINGLEERLINGENVERVOER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BESCHIKKINGLEERLINGENVERVOER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BESCHIKKINGLEERLINGENVERVOER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BESCHIKKINGLEERLINGENVERVOER actions', async () => {
      const arg = 42666;
