...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './vthzaak.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VTHZAAK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VTHZAAK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VTHZAAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VTHZAAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VTHZAAK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VTHZAAK actions', async () => {
      const arg = 42666;
