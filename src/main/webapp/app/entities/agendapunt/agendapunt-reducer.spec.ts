...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AGENDAPUNT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AGENDAPUNT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AGENDAPUNT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AGENDAPUNT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AGENDAPUNT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AGENDAPUNT actions', async () => {
      const arg = 42666;
