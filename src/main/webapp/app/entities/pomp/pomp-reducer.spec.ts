...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './pomp.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POMP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_POMP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_POMP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_POMP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_POMP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_POMP actions', async () => {
      const arg = 42666;
