...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BREDEINTAKE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BREDEINTAKE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BREDEINTAKE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BREDEINTAKE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BREDEINTAKE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BREDEINTAKE actions', async () => {
      const arg = 42666;
