...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INONDERZOEK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INONDERZOEK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INONDERZOEK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INONDERZOEK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INONDERZOEK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INONDERZOEK actions', async () => {
      const arg = 42666;
