...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './omgevingsdocument.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OMGEVINGSDOCUMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OMGEVINGSDOCUMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OMGEVINGSDOCUMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OMGEVINGSDOCUMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OMGEVINGSDOCUMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OMGEVINGSDOCUMENT actions', async () => {
      const arg = 42666;
