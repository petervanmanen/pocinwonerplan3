...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './kwaliteitscatalogusopenbareruimte.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KWALITEITSCATALOGUSOPENBARERUIMTE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KWALITEITSCATALOGUSOPENBARERUIMTE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KWALITEITSCATALOGUSOPENBARERUIMTE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_KWALITEITSCATALOGUSOPENBARERUIMTE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_KWALITEITSCATALOGUSOPENBARERUIMTE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KWALITEITSCATALOGUSOPENBARERUIMTE actions', async () => {
      const arg = 42666;
