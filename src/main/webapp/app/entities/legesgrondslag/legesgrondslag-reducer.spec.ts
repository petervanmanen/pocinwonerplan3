...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEGESGRONDSLAG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LEGESGRONDSLAG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LEGESGRONDSLAG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LEGESGRONDSLAG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LEGESGRONDSLAG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LEGESGRONDSLAG actions', async () => {
      const arg = 42666;
