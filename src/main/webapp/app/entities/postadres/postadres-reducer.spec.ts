...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './postadres.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POSTADRES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_POSTADRES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_POSTADRES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_POSTADRES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_POSTADRES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_POSTADRES actions', async () => {
      const arg = 42666;
