...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './boa.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BOA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BOA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BOA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BOA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BOA actions', async () => {
      const arg = 42666;
