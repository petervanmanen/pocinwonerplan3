...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './bedrijfsprocestype.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BEDRIJFSPROCESTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BEDRIJFSPROCESTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BEDRIJFSPROCESTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BEDRIJFSPROCESTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BEDRIJFSPROCESTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BEDRIJFSPROCESTYPE actions', async () => {
      const arg = 42666;
