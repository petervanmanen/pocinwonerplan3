...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './cpvcode.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CPVCODE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CPVCODE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CPVCODE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CPVCODE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CPVCODE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CPVCODE actions', async () => {
      const arg = 42666;
