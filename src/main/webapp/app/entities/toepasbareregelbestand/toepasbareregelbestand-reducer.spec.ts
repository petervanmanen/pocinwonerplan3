...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './toepasbareregelbestand.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOEPASBAREREGELBESTAND_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TOEPASBAREREGELBESTAND actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TOEPASBAREREGELBESTAND actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TOEPASBAREREGELBESTAND actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TOEPASBAREREGELBESTAND actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TOEPASBAREREGELBESTAND actions', async () => {
      const arg = 42666;
