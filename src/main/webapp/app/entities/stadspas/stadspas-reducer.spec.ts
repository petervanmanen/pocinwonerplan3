...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './stadspas.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STADSPAS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STADSPAS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STADSPAS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STADSPAS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STADSPAS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STADSPAS actions', async () => {
      const arg = 42666;
