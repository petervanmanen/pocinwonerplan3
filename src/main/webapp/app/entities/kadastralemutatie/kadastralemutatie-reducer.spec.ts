...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './kadastralemutatie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KADASTRALEMUTATIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KADASTRALEMUTATIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KADASTRALEMUTATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_KADASTRALEMUTATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_KADASTRALEMUTATIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KADASTRALEMUTATIE actions', async () => {
      const arg = 42666;
