...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './organisatorischeeenheid.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORGANISATORISCHEEENHEID_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ORGANISATORISCHEEENHEID actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ORGANISATORISCHEEENHEID actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ORGANISATORISCHEEENHEID actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ORGANISATORISCHEEENHEID actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ORGANISATORISCHEEENHEID actions', async () => {
      const arg = 42666;
