...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './besluit.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BESLUIT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BESLUIT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BESLUIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BESLUIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BESLUIT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BESLUIT actions', async () => {
      const arg = 42666;
