...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './kadastralegemeente.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KADASTRALEGEMEENTE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KADASTRALEGEMEENTE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KADASTRALEGEMEENTE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_KADASTRALEGEMEENTE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_KADASTRALEGEMEENTE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KADASTRALEGEMEENTE actions', async () => {
      const arg = 42666;
