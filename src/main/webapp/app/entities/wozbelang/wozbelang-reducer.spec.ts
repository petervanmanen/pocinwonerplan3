...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './wozbelang.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WOZBELANG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WOZBELANG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WOZBELANG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WOZBELANG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WOZBELANG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WOZBELANG actions', async () => {
      const arg = 42666;
