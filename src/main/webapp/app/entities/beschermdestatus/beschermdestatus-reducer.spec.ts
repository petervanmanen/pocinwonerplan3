...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BESCHERMDESTATUS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BESCHERMDESTATUS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BESCHERMDESTATUS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BESCHERMDESTATUS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BESCHERMDESTATUS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BESCHERMDESTATUS actions', async () => {
      const arg = 42666;
