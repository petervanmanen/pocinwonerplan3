...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './periode.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PERIODE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PERIODE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PERIODE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PERIODE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PERIODE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PERIODE actions', async () => {
      const arg = 42666;
