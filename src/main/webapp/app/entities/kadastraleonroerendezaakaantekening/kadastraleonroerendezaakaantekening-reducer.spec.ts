...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './kadastraleonroerendezaakaantekening.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KADASTRALEONROERENDEZAAKAANTEKENING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KADASTRALEONROERENDEZAAKAANTEKENING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KADASTRALEONROERENDEZAAKAANTEKENING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_KADASTRALEONROERENDEZAAKAANTEKENING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_KADASTRALEONROERENDEZAAKAANTEKENING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KADASTRALEONROERENDEZAAKAANTEKENING actions', async () => {
      const arg = 42666;
