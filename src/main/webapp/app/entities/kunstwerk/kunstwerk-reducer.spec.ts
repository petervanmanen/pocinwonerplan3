...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './kunstwerk.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KUNSTWERK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KUNSTWERK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KUNSTWERK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_KUNSTWERK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_KUNSTWERK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KUNSTWERK actions', async () => {
      const arg = 42666;
