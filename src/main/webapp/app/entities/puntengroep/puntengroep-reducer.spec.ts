...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PUNTENGROEP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PUNTENGROEP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PUNTENGROEP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PUNTENGROEP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PUNTENGROEP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PUNTENGROEP actions', async () => {
      const arg = 42666;
