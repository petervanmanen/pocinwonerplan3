...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRIJSAFSPRAAK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRIJSAFSPRAAK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRIJSAFSPRAAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRIJSAFSPRAAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRIJSAFSPRAAK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRIJSAFSPRAAK actions', async () => {
      const arg = 42666;
