...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './factuur.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FACTUUR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FACTUUR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FACTUUR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FACTUUR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FACTUUR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FACTUUR actions', async () => {
      const arg = 42666;
