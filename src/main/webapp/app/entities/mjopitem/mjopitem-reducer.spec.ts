...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './mjopitem.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MJOPITEM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MJOPITEM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MJOPITEM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MJOPITEM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MJOPITEM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MJOPITEM actions', async () => {
      const arg = 42666;
