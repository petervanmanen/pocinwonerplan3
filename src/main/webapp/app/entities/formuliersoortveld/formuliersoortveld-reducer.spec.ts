...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './formuliersoortveld.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FORMULIERSOORTVELD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FORMULIERSOORTVELD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FORMULIERSOORTVELD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FORMULIERSOORTVELD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FORMULIERSOORTVELD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FORMULIERSOORTVELD actions', async () => {
      const arg = 42666;
