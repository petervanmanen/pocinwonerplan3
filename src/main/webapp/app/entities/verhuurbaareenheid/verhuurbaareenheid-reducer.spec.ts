...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './verhuurbaareenheid.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VERHUURBAAREENHEID_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VERHUURBAAREENHEID actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VERHUURBAAREENHEID actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VERHUURBAAREENHEID actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VERHUURBAAREENHEID actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VERHUURBAAREENHEID actions', async () => {
      const arg = 42666;
