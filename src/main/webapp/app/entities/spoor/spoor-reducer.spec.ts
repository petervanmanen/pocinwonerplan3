...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './spoor.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPOOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SPOOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SPOOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SPOOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SPOOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SPOOR actions', async () => {
      const arg = 42666;
