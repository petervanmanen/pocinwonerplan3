...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './verzuim.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VERZUIM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VERZUIM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VERZUIM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VERZUIM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VERZUIM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VERZUIM actions', async () => {
      const arg = 42666;
