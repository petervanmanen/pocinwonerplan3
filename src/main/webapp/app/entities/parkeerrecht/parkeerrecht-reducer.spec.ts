...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARKEERRECHT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PARKEERRECHT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PARKEERRECHT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PARKEERRECHT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PARKEERRECHT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PARKEERRECHT actions', async () => {
      const arg = 42666;
