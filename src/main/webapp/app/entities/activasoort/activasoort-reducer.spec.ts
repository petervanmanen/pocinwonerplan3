...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACTIVASOORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ACTIVASOORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ACTIVASOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ACTIVASOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ACTIVASOORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ACTIVASOORT actions', async () => {
      const arg = 42666;
