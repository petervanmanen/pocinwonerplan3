...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TELEFOONSTATUS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TELEFOONSTATUS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TELEFOONSTATUS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TELEFOONSTATUS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TELEFOONSTATUS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TELEFOONSTATUS actions', async () => {
      const arg = 42666;
