...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MELDINGONGEVAL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MELDINGONGEVAL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MELDINGONGEVAL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MELDINGONGEVAL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MELDINGONGEVAL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MELDINGONGEVAL actions', async () => {
      const arg = 42666;
