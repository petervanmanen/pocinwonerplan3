...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BRIEFADRES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BRIEFADRES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BRIEFADRES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BRIEFADRES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BRIEFADRES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BRIEFADRES actions', async () => {
      const arg = 42666;
