...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACADEMISCHETITEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ACADEMISCHETITEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ACADEMISCHETITEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ACADEMISCHETITEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ACADEMISCHETITEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ACADEMISCHETITEL actions', async () => {
      const arg = 42666;
