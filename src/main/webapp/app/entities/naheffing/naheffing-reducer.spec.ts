...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './naheffing.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NAHEFFING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NAHEFFING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NAHEFFING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_NAHEFFING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_NAHEFFING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NAHEFFING actions', async () => {
      const arg = 42666;
