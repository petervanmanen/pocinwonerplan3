...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEVERANCIER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LEVERANCIER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LEVERANCIER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LEVERANCIER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LEVERANCIER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LEVERANCIER actions', async () => {
      const arg = 42666;
