...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ONDERWIJSSOORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ONDERWIJSSOORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ONDERWIJSSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ONDERWIJSSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ONDERWIJSSOORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ONDERWIJSSOORT actions', async () => {
      const arg = 42666;
