...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './boom.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOOM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BOOM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BOOM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BOOM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BOOM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BOOM actions', async () => {
      const arg = 42666;
