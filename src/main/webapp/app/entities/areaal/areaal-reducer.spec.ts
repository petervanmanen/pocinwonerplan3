...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './areaal.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AREAAL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AREAAL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AREAAL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AREAAL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AREAAL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AREAAL actions', async () => {
      const arg = 42666;
