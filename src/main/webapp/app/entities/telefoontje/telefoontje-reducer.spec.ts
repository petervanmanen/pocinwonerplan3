...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TELEFOONTJE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TELEFOONTJE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TELEFOONTJE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TELEFOONTJE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TELEFOONTJE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TELEFOONTJE actions', async () => {
      const arg = 42666;
