...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LANDOFGEBIED_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LANDOFGEBIED actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LANDOFGEBIED actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LANDOFGEBIED actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LANDOFGEBIED actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LANDOFGEBIED actions', async () => {
      const arg = 42666;
