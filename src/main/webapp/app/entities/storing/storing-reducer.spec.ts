...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './storing.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STORING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STORING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STORING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STORING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STORING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STORING actions', async () => {
      const arg = 42666;
