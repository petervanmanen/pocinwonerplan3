...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bevinding.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BEVINDING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BEVINDING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BEVINDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BEVINDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BEVINDING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BEVINDING actions', async () => {
      const arg = 42666;
