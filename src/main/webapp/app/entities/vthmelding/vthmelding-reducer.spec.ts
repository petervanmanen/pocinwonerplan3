...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VTHMELDING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VTHMELDING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VTHMELDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VTHMELDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VTHMELDING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VTHMELDING actions', async () => {
      const arg = 42666;
