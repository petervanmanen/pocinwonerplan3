...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './partij.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARTIJ_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PARTIJ actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PARTIJ actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PARTIJ actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PARTIJ actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PARTIJ actions', async () => {
      const arg = 42666;
