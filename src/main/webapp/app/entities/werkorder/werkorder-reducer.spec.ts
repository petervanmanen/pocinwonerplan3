...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './werkorder.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WERKORDER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WERKORDER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WERKORDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WERKORDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WERKORDER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WERKORDER actions', async () => {
      const arg = 42666;
