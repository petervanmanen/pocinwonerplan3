...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEEFGEBIED_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LEEFGEBIED actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LEEFGEBIED actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LEEFGEBIED actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LEEFGEBIED actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LEEFGEBIED actions', async () => {
      const arg = 42666;
