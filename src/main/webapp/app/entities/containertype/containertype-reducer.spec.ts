...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTAINERTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CONTAINERTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CONTAINERTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CONTAINERTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CONTAINERTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CONTAINERTYPE actions', async () => {
      const arg = 42666;
