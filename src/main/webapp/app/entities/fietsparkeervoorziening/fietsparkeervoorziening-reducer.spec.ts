...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './fietsparkeervoorziening.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FIETSPARKEERVOORZIENING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FIETSPARKEERVOORZIENING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FIETSPARKEERVOORZIENING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FIETSPARKEERVOORZIENING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FIETSPARKEERVOORZIENING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FIETSPARKEERVOORZIENING actions', async () => {
      const arg = 42666;
