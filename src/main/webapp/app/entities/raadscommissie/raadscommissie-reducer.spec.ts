...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RAADSCOMMISSIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RAADSCOMMISSIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RAADSCOMMISSIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RAADSCOMMISSIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RAADSCOMMISSIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RAADSCOMMISSIE actions', async () => {
      const arg = 42666;
