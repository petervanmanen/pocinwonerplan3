...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './scheiding.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SCHEIDING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SCHEIDING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SCHEIDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SCHEIDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SCHEIDING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SCHEIDING actions', async () => {
      const arg = 42666;
