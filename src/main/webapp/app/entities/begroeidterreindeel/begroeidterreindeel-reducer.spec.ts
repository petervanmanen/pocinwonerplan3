...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './begroeidterreindeel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BEGROEIDTERREINDEEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BEGROEIDTERREINDEEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BEGROEIDTERREINDEEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BEGROEIDTERREINDEEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BEGROEIDTERREINDEEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BEGROEIDTERREINDEEL actions', async () => {
      const arg = 42666;
