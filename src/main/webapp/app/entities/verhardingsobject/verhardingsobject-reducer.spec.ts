...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './verhardingsobject.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VERHARDINGSOBJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VERHARDINGSOBJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VERHARDINGSOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VERHARDINGSOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VERHARDINGSOBJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VERHARDINGSOBJECT actions', async () => {
      const arg = 42666;
