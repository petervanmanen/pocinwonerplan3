...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bruikleen.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BRUIKLEEN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BRUIKLEEN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BRUIKLEEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BRUIKLEEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BRUIKLEEN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BRUIKLEEN actions', async () => {
      const arg = 42666;
