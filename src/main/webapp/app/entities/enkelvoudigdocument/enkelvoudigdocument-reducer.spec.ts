...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './enkelvoudigdocument.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENKELVOUDIGDOCUMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ENKELVOUDIGDOCUMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ENKELVOUDIGDOCUMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ENKELVOUDIGDOCUMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ENKELVOUDIGDOCUMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ENKELVOUDIGDOCUMENT actions', async () => {
      const arg = 42666;
