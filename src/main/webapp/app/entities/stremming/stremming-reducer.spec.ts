...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './stremming.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STREMMING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STREMMING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STREMMING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STREMMING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STREMMING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STREMMING actions', async () => {
      const arg = 42666;
