...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './cultuurcodeonbebouwd.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CULTUURCODEONBEBOUWD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CULTUURCODEONBEBOUWD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CULTUURCODEONBEBOUWD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CULTUURCODEONBEBOUWD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CULTUURCODEONBEBOUWD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CULTUURCODEONBEBOUWD actions', async () => {
      const arg = 42666;
