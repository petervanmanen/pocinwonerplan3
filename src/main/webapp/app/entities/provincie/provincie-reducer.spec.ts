...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './provincie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROVINCIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PROVINCIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PROVINCIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PROVINCIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PROVINCIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PROVINCIE actions', async () => {
      const arg = 42666;
