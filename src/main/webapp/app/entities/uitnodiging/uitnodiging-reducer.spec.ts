...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UITNODIGING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_UITNODIGING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_UITNODIGING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_UITNODIGING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_UITNODIGING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_UITNODIGING actions', async () => {
      const arg = 42666;
