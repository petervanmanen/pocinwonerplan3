...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './levering.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEVERING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LEVERING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LEVERING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LEVERING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LEVERING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LEVERING actions', async () => {
      const arg = 42666;
