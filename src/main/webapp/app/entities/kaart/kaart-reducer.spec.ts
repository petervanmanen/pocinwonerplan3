...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './kaart.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KAART_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KAART actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KAART actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_KAART actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_KAART actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KAART actions', async () => {
      const arg = 42666;
