...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RAPPORTAGEMOMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RAPPORTAGEMOMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RAPPORTAGEMOMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RAPPORTAGEMOMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RAPPORTAGEMOMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RAPPORTAGEMOMENT actions', async () => {
      const arg = 42666;
