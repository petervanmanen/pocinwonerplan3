...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BESCHIKKINGSOORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BESCHIKKINGSOORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BESCHIKKINGSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BESCHIKKINGSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BESCHIKKINGSOORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BESCHIKKINGSOORT actions', async () => {
      const arg = 42666;
