...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './aanvraagvrijstelling.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AANVRAAGVRIJSTELLING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AANVRAAGVRIJSTELLING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AANVRAAGVRIJSTELLING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AANVRAAGVRIJSTELLING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AANVRAAGVRIJSTELLING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AANVRAAGVRIJSTELLING actions', async () => {
      const arg = 42666;
