...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './wegdeel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WEGDEEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WEGDEEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WEGDEEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WEGDEEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WEGDEEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WEGDEEL actions', async () => {
      const arg = 42666;
