...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BEGROTINGREGEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BEGROTINGREGEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BEGROTINGREGEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BEGROTINGREGEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BEGROTINGREGEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BEGROTINGREGEL actions', async () => {
      const arg = 42666;
