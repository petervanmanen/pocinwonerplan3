...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bouwwerk.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOUWWERK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BOUWWERK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BOUWWERK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BOUWWERK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BOUWWERK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BOUWWERK actions', async () => {
      const arg = 42666;
