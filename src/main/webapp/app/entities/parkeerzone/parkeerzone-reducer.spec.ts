...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARKEERZONE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PARKEERZONE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PARKEERZONE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PARKEERZONE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PARKEERZONE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PARKEERZONE actions', async () => {
      const arg = 42666;
