...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './eobject.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EOBJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EOBJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_EOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_EOBJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EOBJECT actions', async () => {
      const arg = 42666;
