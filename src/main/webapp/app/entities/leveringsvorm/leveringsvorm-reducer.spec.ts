...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEVERINGSVORM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LEVERINGSVORM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LEVERINGSVORM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LEVERINGSVORM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LEVERINGSVORM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LEVERINGSVORM actions', async () => {
      const arg = 42666;
