...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './vlak.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VLAK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VLAK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VLAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VLAK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VLAK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VLAK actions', async () => {
      const arg = 42666;
