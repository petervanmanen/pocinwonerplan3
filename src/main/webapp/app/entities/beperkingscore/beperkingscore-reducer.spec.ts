...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BEPERKINGSCORE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BEPERKINGSCORE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BEPERKINGSCORE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BEPERKINGSCORE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BEPERKINGSCORE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BEPERKINGSCORE actions', async () => {
      const arg = 42666;
