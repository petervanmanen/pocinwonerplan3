...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROGRAMMASOORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PROGRAMMASOORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PROGRAMMASOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PROGRAMMASOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PROGRAMMASOORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PROGRAMMASOORT actions', async () => {
      const arg = 42666;
