...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOORTSPOOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SOORTSPOOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SOORTSPOOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SOORTSPOOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SOORTSPOOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SOORTSPOOR actions', async () => {
      const arg = 42666;
