...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './wijk.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WIJK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WIJK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WIJK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WIJK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WIJK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WIJK actions', async () => {
      const arg = 42666;
