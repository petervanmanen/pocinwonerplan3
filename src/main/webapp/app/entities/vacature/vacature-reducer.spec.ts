...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './vacature.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VACATURE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VACATURE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VACATURE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VACATURE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VACATURE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VACATURE actions', async () => {
      const arg = 42666;
