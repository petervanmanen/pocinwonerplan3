...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JURIDISCHEREGEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_JURIDISCHEREGEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_JURIDISCHEREGEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_JURIDISCHEREGEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_JURIDISCHEREGEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_JURIDISCHEREGEL actions', async () => {
      const arg = 42666;
