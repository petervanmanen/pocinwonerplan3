...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DIENSTVERBAND_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DIENSTVERBAND actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DIENSTVERBAND actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DIENSTVERBAND actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DIENSTVERBAND actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DIENSTVERBAND actions', async () => {
      const arg = 42666;
