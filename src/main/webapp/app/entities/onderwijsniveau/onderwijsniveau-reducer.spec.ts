...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ONDERWIJSNIVEAU_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ONDERWIJSNIVEAU actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ONDERWIJSNIVEAU actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ONDERWIJSNIVEAU actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ONDERWIJSNIVEAU actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ONDERWIJSNIVEAU actions', async () => {
      const arg = 42666;
