...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BESLUITTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BESLUITTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BESLUITTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BESLUITTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BESLUITTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BESLUITTYPE actions', async () => {
      const arg = 42666;
