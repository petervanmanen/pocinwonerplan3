...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './thema.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_THEMA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_THEMA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_THEMA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_THEMA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_THEMA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_THEMA actions', async () => {
      const arg = 42666;
