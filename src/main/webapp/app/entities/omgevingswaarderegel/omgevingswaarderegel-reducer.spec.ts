...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './omgevingswaarderegel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OMGEVINGSWAARDEREGEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OMGEVINGSWAARDEREGEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OMGEVINGSWAARDEREGEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OMGEVINGSWAARDEREGEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OMGEVINGSWAARDEREGEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OMGEVINGSWAARDEREGEL actions', async () => {
      const arg = 42666;
