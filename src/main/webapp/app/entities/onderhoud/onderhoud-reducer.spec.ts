...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './onderhoud.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ONDERHOUD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ONDERHOUD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ONDERHOUD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ONDERHOUD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ONDERHOUD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ONDERHOUD actions', async () => {
      const arg = 42666;
