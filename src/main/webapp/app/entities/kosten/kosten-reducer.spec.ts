...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './kosten.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KOSTEN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KOSTEN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KOSTEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_KOSTEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_KOSTEN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KOSTEN actions', async () => {
      const arg = 42666;
