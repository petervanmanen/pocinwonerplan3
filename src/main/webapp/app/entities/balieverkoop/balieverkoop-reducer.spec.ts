...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BALIEVERKOOP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BALIEVERKOOP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BALIEVERKOOP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BALIEVERKOOP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BALIEVERKOOP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BALIEVERKOOP actions', async () => {
      const arg = 42666;
