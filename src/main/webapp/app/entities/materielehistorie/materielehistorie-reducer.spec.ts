...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './materielehistorie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MATERIELEHISTORIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MATERIELEHISTORIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MATERIELEHISTORIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MATERIELEHISTORIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MATERIELEHISTORIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MATERIELEHISTORIE actions', async () => {
      const arg = 42666;
