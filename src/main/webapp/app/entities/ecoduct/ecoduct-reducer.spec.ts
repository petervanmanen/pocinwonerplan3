...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ecoduct.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ECODUCT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ECODUCT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ECODUCT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ECODUCT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ECODUCT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ECODUCT actions', async () => {
      const arg = 42666;
