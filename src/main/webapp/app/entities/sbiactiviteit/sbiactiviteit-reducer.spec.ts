...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SBIACTIVITEIT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SBIACTIVITEIT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SBIACTIVITEIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SBIACTIVITEIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SBIACTIVITEIT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SBIACTIVITEIT actions', async () => {
      const arg = 42666;
