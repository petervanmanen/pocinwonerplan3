...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './mailing.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MAILING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MAILING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MAILING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MAILING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MAILING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MAILING actions', async () => {
      const arg = 42666;
