...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './inrichtingselement.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INRICHTINGSELEMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INRICHTINGSELEMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INRICHTINGSELEMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INRICHTINGSELEMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INRICHTINGSELEMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INRICHTINGSELEMENT actions', async () => {
      const arg = 42666;
