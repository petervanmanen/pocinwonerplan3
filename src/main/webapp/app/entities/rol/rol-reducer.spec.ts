...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './rol.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ROL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ROL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ROL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ROL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ROL actions', async () => {
      const arg = 42666;
