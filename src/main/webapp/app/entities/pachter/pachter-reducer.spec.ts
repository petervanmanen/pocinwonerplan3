...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './pachter.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PACHTER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PACHTER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PACHTER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PACHTER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PACHTER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PACHTER actions', async () => {
      const arg = 42666;
