...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './melding.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MELDING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MELDING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MELDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MELDING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MELDING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MELDING actions', async () => {
      const arg = 42666;
