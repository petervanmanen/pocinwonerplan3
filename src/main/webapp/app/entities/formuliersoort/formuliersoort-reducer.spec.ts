...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FORMULIERSOORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FORMULIERSOORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FORMULIERSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FORMULIERSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FORMULIERSOORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FORMULIERSOORT actions', async () => {
      const arg = 42666;
