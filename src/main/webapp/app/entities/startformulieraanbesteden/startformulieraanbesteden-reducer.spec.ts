...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './startformulieraanbesteden.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STARTFORMULIERAANBESTEDEN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STARTFORMULIERAANBESTEDEN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STARTFORMULIERAANBESTEDEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STARTFORMULIERAANBESTEDEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STARTFORMULIERAANBESTEDEN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STARTFORMULIERAANBESTEDEN actions', async () => {
      const arg = 42666;
