...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FORMULIERINHUUR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FORMULIERINHUUR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FORMULIERINHUUR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FORMULIERINHUUR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FORMULIERINHUUR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FORMULIERINHUUR actions', async () => {
      const arg = 42666;
