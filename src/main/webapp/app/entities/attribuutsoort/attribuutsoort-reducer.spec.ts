...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ATTRIBUUTSOORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ATTRIBUUTSOORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ATTRIBUUTSOORT actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_ATTRIBUUTSOORT actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_ATTRIBUUTSOORT actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_ATTRIBUUTSOORT actions', async () => {
      const arg = 42666;
