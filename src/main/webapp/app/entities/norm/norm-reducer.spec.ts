...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './norm.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NORM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NORM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NORM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_NORM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_NORM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NORM actions', async () => {
      const arg = 42666;
