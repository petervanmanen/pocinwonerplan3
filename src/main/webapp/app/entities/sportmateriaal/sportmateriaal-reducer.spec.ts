...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPORTMATERIAAL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SPORTMATERIAAL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SPORTMATERIAAL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SPORTMATERIAAL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SPORTMATERIAAL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SPORTMATERIAAL actions', async () => {
      const arg = 42666;
