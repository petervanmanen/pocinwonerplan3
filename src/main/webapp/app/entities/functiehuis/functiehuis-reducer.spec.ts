...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FUNCTIEHUIS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FUNCTIEHUIS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FUNCTIEHUIS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FUNCTIEHUIS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FUNCTIEHUIS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FUNCTIEHUIS actions', async () => {
      const arg = 42666;
