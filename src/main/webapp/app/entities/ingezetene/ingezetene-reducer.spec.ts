...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INGEZETENE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INGEZETENE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INGEZETENE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INGEZETENE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INGEZETENE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INGEZETENE actions', async () => {
      const arg = 42666;
