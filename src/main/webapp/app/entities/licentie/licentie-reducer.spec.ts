...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './licentie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LICENTIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LICENTIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LICENTIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LICENTIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LICENTIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LICENTIE actions', async () => {
      const arg = 42666;
