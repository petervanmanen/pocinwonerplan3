...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KPCLASSACLASSC_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KPCLASSACLASSC actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KPCLASSACLASSC actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_KPCLASSACLASSC actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_KPCLASSACLASSC actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KPCLASSACLASSC actions', async () => {
      const arg = 42666;
