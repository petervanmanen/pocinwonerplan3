...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './flyover.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FLYOVER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FLYOVER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FLYOVER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FLYOVER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FLYOVER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FLYOVER actions', async () => {
      const arg = 42666;
