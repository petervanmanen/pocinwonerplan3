...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './wozwaarde.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WOZWAARDE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WOZWAARDE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WOZWAARDE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WOZWAARDE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WOZWAARDE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WOZWAARDE actions', async () => {
      const arg = 42666;
