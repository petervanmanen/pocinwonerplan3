...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './dienst.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DIENST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DIENST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DIENST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DIENST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DIENST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DIENST actions', async () => {
      const arg = 42666;
