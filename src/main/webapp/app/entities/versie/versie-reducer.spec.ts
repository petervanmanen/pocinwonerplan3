...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './versie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VERSIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VERSIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VERSIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VERSIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VERSIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VERSIE actions', async () => {
      const arg = 42666;
