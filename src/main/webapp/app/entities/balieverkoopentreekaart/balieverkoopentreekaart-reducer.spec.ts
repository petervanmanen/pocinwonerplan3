...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './balieverkoopentreekaart.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BALIEVERKOOPENTREEKAART_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BALIEVERKOOPENTREEKAART actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BALIEVERKOOPENTREEKAART actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BALIEVERKOOPENTREEKAART actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BALIEVERKOOPENTREEKAART actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BALIEVERKOOPENTREEKAART actions', async () => {
      const arg = 42666;
