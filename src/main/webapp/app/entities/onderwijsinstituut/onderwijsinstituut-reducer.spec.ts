...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './onderwijsinstituut.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ONDERWIJSINSTITUUT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ONDERWIJSINSTITUUT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ONDERWIJSINSTITUUT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ONDERWIJSINSTITUUT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ONDERWIJSINSTITUUT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ONDERWIJSINSTITUUT actions', async () => {
      const arg = 42666;
