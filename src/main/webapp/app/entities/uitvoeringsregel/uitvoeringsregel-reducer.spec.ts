...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UITVOERINGSREGEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_UITVOERINGSREGEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_UITVOERINGSREGEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_UITVOERINGSREGEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_UITVOERINGSREGEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_UITVOERINGSREGEL actions', async () => {
      const arg = 42666;
