...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './overiggebouwdobject.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OVERIGGEBOUWDOBJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OVERIGGEBOUWDOBJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OVERIGGEBOUWDOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OVERIGGEBOUWDOBJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OVERIGGEBOUWDOBJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OVERIGGEBOUWDOBJECT actions', async () => {
      const arg = 42666;
