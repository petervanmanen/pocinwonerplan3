...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './aardzakelijkrecht.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AARDZAKELIJKRECHT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AARDZAKELIJKRECHT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AARDZAKELIJKRECHT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AARDZAKELIJKRECHT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AARDZAKELIJKRECHT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AARDZAKELIJKRECHT actions', async () => {
      const arg = 42666;
