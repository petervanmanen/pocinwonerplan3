...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GEMACHTIGDE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GEMACHTIGDE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GEMACHTIGDE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_GEMACHTIGDE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_GEMACHTIGDE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GEMACHTIGDE actions', async () => {
      const arg = 42666;
