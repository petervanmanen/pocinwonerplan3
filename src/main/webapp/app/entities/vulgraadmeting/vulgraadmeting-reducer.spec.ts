...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VULGRAADMETING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VULGRAADMETING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VULGRAADMETING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VULGRAADMETING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VULGRAADMETING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VULGRAADMETING actions', async () => {
      const arg = 42666;
