...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BRONDOCUMENTEN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BRONDOCUMENTEN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BRONDOCUMENTEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BRONDOCUMENTEN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BRONDOCUMENTEN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BRONDOCUMENTEN actions', async () => {
      const arg = 42666;
