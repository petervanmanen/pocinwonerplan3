...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPORTTERREIN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SPORTTERREIN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SPORTTERREIN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SPORTTERREIN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SPORTTERREIN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SPORTTERREIN actions', async () => {
      const arg = 42666;
