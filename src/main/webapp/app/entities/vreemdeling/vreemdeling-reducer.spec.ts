...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VREEMDELING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VREEMDELING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VREEMDELING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VREEMDELING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VREEMDELING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VREEMDELING actions', async () => {
      const arg = 42666;
