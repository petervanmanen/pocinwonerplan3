...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VERKEERSDREMPEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VERKEERSDREMPEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VERKEERSDREMPEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VERKEERSDREMPEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VERKEERSDREMPEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VERKEERSDREMPEL actions', async () => {
      const arg = 42666;
