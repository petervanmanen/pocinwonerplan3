...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './verlof.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VERLOF_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VERLOF actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VERLOF actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VERLOF actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VERLOF actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VERLOF actions', async () => {
      const arg = 42666;
