...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './ondersteunendwaterdeel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ONDERSTEUNENDWATERDEEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ONDERSTEUNENDWATERDEEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ONDERSTEUNENDWATERDEEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ONDERSTEUNENDWATERDEEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ONDERSTEUNENDWATERDEEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ONDERSTEUNENDWATERDEEL actions', async () => {
      const arg = 42666;
