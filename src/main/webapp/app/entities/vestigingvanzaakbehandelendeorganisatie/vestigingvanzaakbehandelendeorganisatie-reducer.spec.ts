...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './vestigingvanzaakbehandelendeorganisatie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VESTIGINGVANZAAKBEHANDELENDEORGANISATIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VESTIGINGVANZAAKBEHANDELENDEORGANISATIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VESTIGINGVANZAAKBEHANDELENDEORGANISATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VESTIGINGVANZAAKBEHANDELENDEORGANISATIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VESTIGINGVANZAAKBEHANDELENDEORGANISATIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VESTIGINGVANZAAKBEHANDELENDEORGANISATIE actions', async () => {
      const arg = 42666;
