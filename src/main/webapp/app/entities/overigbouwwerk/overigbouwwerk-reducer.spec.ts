...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OVERIGBOUWWERK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OVERIGBOUWWERK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OVERIGBOUWWERK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OVERIGBOUWWERK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OVERIGBOUWWERK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OVERIGBOUWWERK actions', async () => {
      const arg = 42666;
