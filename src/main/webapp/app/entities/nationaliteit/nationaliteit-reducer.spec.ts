...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NATIONALITEIT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NATIONALITEIT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NATIONALITEIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_NATIONALITEIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_NATIONALITEIT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NATIONALITEIT actions', async () => {
      const arg = 42666;
