...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './kast.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KAST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KAST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KAST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_KAST actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_KAST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KAST actions', async () => {
      const arg = 42666;
