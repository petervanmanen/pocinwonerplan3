...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './inburgeringstraject.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INBURGERINGSTRAJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INBURGERINGSTRAJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INBURGERINGSTRAJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_INBURGERINGSTRAJECT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_INBURGERINGSTRAJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INBURGERINGSTRAJECT actions', async () => {
      const arg = 42666;
