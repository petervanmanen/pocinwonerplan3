...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KPONSTAANUIT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_KPONSTAANUIT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_KPONSTAANUIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_KPONSTAANUIT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_KPONSTAANUIT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_KPONSTAANUIT actions', async () => {
      const arg = 42666;
