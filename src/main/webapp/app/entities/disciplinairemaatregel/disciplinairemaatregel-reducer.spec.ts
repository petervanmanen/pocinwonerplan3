...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './disciplinairemaatregel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISCIPLINAIREMAATREGEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DISCIPLINAIREMAATREGEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DISCIPLINAIREMAATREGEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DISCIPLINAIREMAATREGEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DISCIPLINAIREMAATREGEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DISCIPLINAIREMAATREGEL actions', async () => {
      const arg = 42666;
