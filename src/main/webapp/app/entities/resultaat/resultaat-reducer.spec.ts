...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './resultaat.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESULTAAT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RESULTAAT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RESULTAAT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RESULTAAT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RESULTAAT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RESULTAAT actions', async () => {
      const arg = 42666;
