...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESULTAATSOORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RESULTAATSOORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RESULTAATSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RESULTAATSOORT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RESULTAATSOORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RESULTAATSOORT actions', async () => {
      const arg = 42666;
