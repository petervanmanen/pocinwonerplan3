...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AARDAANTEKENING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AARDAANTEKENING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AARDAANTEKENING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AARDAANTEKENING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AARDAANTEKENING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AARDAANTEKENING actions', async () => {
      const arg = 42666;
