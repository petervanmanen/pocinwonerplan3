...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './rioolput.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RIOOLPUT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RIOOLPUT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RIOOLPUT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RIOOLPUT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RIOOLPUT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RIOOLPUT actions', async () => {
      const arg = 42666;
